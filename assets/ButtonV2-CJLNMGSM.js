import{j as s}from"./jsx-runtime-BkBIjjFT.js";import{r as f}from"./index-KmaxkdDD.js";import{B as u}from"./index-BDdHs4nI.js";import{a as n,u as i,b as d,p as b}from"./index-BMLrhZi-.js";import{$ as L}from"./Button-rO-PiLt4.js";import{T as k}from"./Typography-Bt5r6amG.js";import{S as m}from"./Spinner-CArJdDUu.js";const r=n(L)`
...
`,j=n.div`
  ...
  display: grid;
  place-items: center;
`,A=f.forwardRef((t,a)=>{const{variant:o=u.DEFAULT_VARIANT,startIcon:e,fullWidth:y,children:g,testID:c="button",...l}=t,{isPending:h}=l,{tokens:$}=i(),{button:p}=$;return s.jsxs(r,{...l,ref:a,$variant:o,$fullWidth:y,"data-testid":c,children:[s.jsx(w,{$variant:o}),s.jsx(x,{$variant:o,children:s.jsxs(v,{children:[e&&s.jsx(C,{children:e}),s.jsx(R,{children:s.jsx(k,{variant:p.topLayer.text.typography.variant,fontFamily:p.topLayer.text.typography.fontFamily,noWrap:!0,color:"inherit",component:"div",testID:`${c}-text`,children:g})}),h&&s.jsx(j,{children:s.jsx(m,{"aria-label":"Loading...",variant:u.SPINNER_VARIANTS[o],testID:`${c}-spinner`})})]})})]})});export{A as B};
