import{a as d,u as s,b as n,j as i}from"./index-1154a484.js";import{r as c}from"./index-c013ead5.js";import{u as g}from"./floating-ui.react-9ca6c674.js";import{M as w,T as m}from"./index-8544f6ee.js";const h=d.div`
...
`,x=d(m)`
  ${()=>{const{tokens:t}=s(),{checkbox:o}=t;return[n`
      ...
      `]}}
`;function C(t,o){c.useEffect(()=>{t.current&&(t.current.indeterminate=!!o)},[o])}const R=c.forwardRef((t,o)=>{const{hasError:e,isIndeterminate:a,testID:b="checkbox",...r}=t,l=c.useRef(null);C(l,a);const $=g([l,o]);function p(u){var k;u.target.indeterminate=!!a,(k=r.onChange)==null||k.call(r,u)}return i.jsxs(h,{$hasError:e,children:[i.jsx(v,{...r,ref:$,type:"checkbox",onChange:p,"data-testid":b}),i.jsx(f,{}),i.jsx(x,{})]})});export{R as C};
