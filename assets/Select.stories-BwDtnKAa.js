import{j as n}from"./jsx-runtime-BkBIjjFT.js";import{f as B}from"./index-D0csYWE-.js";import{e as v}from"./index-VIbBARS4.js";import{S as i}from"./Select-PuMM3yt8.js";const{useArgs:D}=__STORYBOOK_MODULE_PREVIEW_API__,I={title:"Components/Inputs/Select",component:i,render:function(l){const[,E]=D();function L(s){l.onChange(s),E({selectedItem:s})}return n.jsx("div",{style:{height:420},children:n.jsx(i,{...l,onChange:L})})},argTypes:{labelProps:{control:{disable:!0}},placeholder:{type:"string"},items:{control:{disable:!0}},selectedItem:{control:{disable:!0}},onChange:{control:{disable:!0}},alertProps:{control:{disable:!0}},hasError:{type:"boolean"},isDisabled:{type:"boolean"}},args:{placeholder:"Select",items:v.mockItems,selectedItem:null,onChange:B(),hasError:!1,isDisabled:!1}},e={args:{labelProps:{"aria-label":"Label"}}},r={args:{isDisabled:!0,labelProps:{"aria-label":"Label"}}},a={args:{labelProps:{label:"Label for Select [DRC#2]",labelTooltipProps:{iconButtonProps:{"aria-label":"Button label"},contentProps:{children:"APR stands for Annual Percentage Rate. It's the rate you will have to pay for the chosen loan amount."}}}}},o={args:{labelProps:{label:"Label for Select",labelHint:"Additional information",labelHintTooltipProps:{iconButtonProps:{"aria-label":"Button label"},contentProps:{children:"APR stands for Annual Percentage Rate. It's the rate you will have to pay for the chosen loan amount."}}}}},t={args:{hasError:!0,labelProps:{label:"Label for Select"},alertProps:{severity:"error",children:"Error description over two lines if required."}}};var c,p,b;e.parameters={...e.parameters,docs:{...(c=e.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
    labelProps: {
      "aria-label": "Label"
    }
