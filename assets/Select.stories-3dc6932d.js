import{j as r}from"./jsx-runtime-6eef64cc.js";import{f as Y}from"./index-6eef940f.js";import{r as Q}from"./index-c013ead5.js";import{u as Z,S as ee,M as ne,m as te}from"./Select.mocks-0846ac21.js";import{a as g,u as m,b as a}from"./index-f9091704.js";import{T as re}from"./index-b1778622.js";import{I as oe,a as ae}from"./InputAlert-c56755e4.js";import{I as le}from"./InputLabelTop-2946523d.js";import{T}from"./Typography-401b61b3.js";const ie=g.div`
...
`,ce=g(re)`
  ${({$isSelected:t})=>{const{tokens:n}=m(),{select:o}=n;return[a`
      ...
      `]}}
`;function de(t){return t?t.title:""}function f(t){const{labelProps:n,placeholder:o="Select",selectedItem:e,onChange:u,alertProps:y,testID:v="select",...I}=t,{isDisabled:R,items:M}=I,{tokens:N}=m(),{select:b}=N,{getLabelProps:X,getToggleButtonProps:J,getMenuProps:z,isOpen:G,getItemProps:K,highlightedIndex:U}=Z({items:M,selectedItem:e,itemToString:de,onSelectedItemChange:({selectedItem:h})=>u(h)}),P=Q.useId(),{labelHint:V}=n;return r.jsx(oe,{alert:y?r.jsx(ae,{...y,testID:`${v}-alert`}):void 0,children:r.jsx(le,{...n,...X(),labelHintID:P,children:r.jsx(ee,{...I,toggleButtonProps:{"aria-describedby":V?P:void 0},getToggleButtonProps:J,getMenuProps:z,isOpen:G,renderButtonContent:()=>r.jsx(ie,{$isDisabled:R,$hasSelectedItem:!!e,children:r.jsx(T,{component:"div",color:"inherit",variant:b.button.text.typography.variant,fontFamily:b.button.text.typography.fontFamily,noWrap:!0,children:e?e.title:o})}),renderListItem:(h,l,S)=>{const k=e===l,$=U===S;return r.jsx(se,{...K({ref:h,item:l,index:S}),"data-hovered":$||void 0,children:r.jsxs(pe,{$isSelected:k,$isHighlighted:$,children:[r.jsx(ce,{$isSelected:k,"aria-hidden":"true"}),r.jsx(T,{component:"div",color:"inherit",title:l.title,variant:b.menu.option.inner.text.typography.variant,fontFamily:b.menu.option.inner.text.typography.fontFamily,noWrap:!0,children:l.title})]})},l.id)},maxListHeight:ne,testID:v})})})}f.__docgenInfo={description:"",methods:[],displayName:"Select",props:{labelProps:{required:!0,tsType:{name:"Omit",elements:[{name:"intersection",raw:`Omit<
...
>`},description:""},placeholder:{required:!1,tsType:{name:"string"},description:""},selectedItem:{required:!1,tsType:{name:"union",raw:"T | null | undefined",elements:[{name:"T"},{name:"null"},{name:"undefined"}]},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(selectedItem: T | null | undefined) => void",signature:{arguments:[{type:{name:"union",raw:"T | null | undefined",elements:[{name:"T"},{name:"null"},{name:"undefined"}]},name:"selectedItem"}],return:{name:"void"}}},description:""},alertProps:{required:!1,tsType:{name:"intersection",raw:`PropsWithOptionalTestID & {
  ...
  severity: CoreInputAlert.Severity;
  children: string;
}`,signature:{properties:[{key:"severity",value:{name:"CoreInputAlert.Severity",required:!0}},{key:"children",value:{name:"string",required:!0}}]}}]},description:""}}};const{useArgs:me}=__STORYBOOK_MODULE_PREVIEW_API__,ue={title:"Components/Inputs/Select",component:f,render:function(n){const[,o]=me();function e(u){n.onChange(u),o({selectedItem:u})}return r.jsx("div",{style:{height:400},children:r.jsx(f,{...n,onChange:e})})},argTypes:{placeholder:{type:"string"},hasError:{type:"boolean"},isDisabled:{type:"boolean"}},args:{onChange:Y(),items:te,hasError:!1,isDisabled:!1}},i={args:{labelProps:{"aria-label":"Label"}}},s={args:{isDisabled:!0,labelProps:{"aria-label":"Label"}}},p={args:{labelProps:{label:"Label for Select"}}},c={args:{labelProps:{label:"Label for Select",labelHint:"Additional information"}}},d={args:{hasError:!0,labelProps:{label:"Label for Select"},alertProps:{severity:"error",children:"Error description over two lines if required."}}};var H,C,x;i.parameters={...i.parameters,docs:{...(H=i.parameters)==null?void 0:H.docs,source:{originalSource:`{
  args: {
    labelProps: {
      "aria-label": "Label"
    }
...
}`,...(A=(F=d.parameters)==null?void 0:F.docs)==null?void 0:A.source}}};const be=["Basic","Disabled","WithLabel","WithHint","WithError"],$e=Object.freeze(Object.defineProperty({__proto__:null,Basic:i,Disabled:s,WithError:d,WithHint:c,WithLabel:p,__namedExportsOrder:be,default:ue},Symbol.toStringTag,{value:"Module"}));export{i as B,s as D,$e as S,p as W,c as a,d as b};
