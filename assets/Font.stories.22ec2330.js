var y=Object.defineProperty;var d=(t,e)=>y(t,"name",{value:e,configurable:!0});import{S as p,i as x,s as b,r as u,u as B,v as r,a as f,w as T,x as N,q as m,d as L}from"./index.b1c955cf.js";function h(t){let e,s;return{c(){e=u("div"),s=B(t[1]),r(e,"class",t[0])},m(n,l){f(n,e,l),T(e,s)},p(n,[l]){l&2&&N(s,n[1]),l&1&&r(e,"class",n[0])},i:m,o:m,d(n){n&&L(e)}}}d(h,"create_fragment");function H(t,e,s){let{className:n=""}=e,{text:l=""}=e;return t.$$set=i=>{"className"in i&&s(0,n=i.className),"text"in i&&s(1,l=i.text)},[n,l]}d(H,"instance");class c extends p{constructor(e){super(),x(this,e,H,h,b,{className:0,text:1})}}d(c,"Font");const g=c;c.__docgen={version:3,name:"Font.svelte",data:[{visibility:"public",description:null,keywords:[],name:"className",kind:"let",static:!1,readonly:!1,type:{kind:"type",text:"string",type:"string"},defaultValue:""},{visibility:"public",description:null,keywords:[],name:"text",kind:"let",static:!1,readonly:!1,type:{kind:"type",text:"string",type:"string"},defaultValue:""}],computed:[],methods:[],components:[],description:null,keywords:[],events:[],slots:[],refs:[]};const a="The quick brown fox jumps over the lazy dog",j={parameters:{storySource:{source:`import Font from "./Font.svelte";

const samepleText = "The quick brown fox jumps over the lazy dog";

export default {
  title: "Components/Fonts/Font",
  component: Font,
  argTypes: {
    text: { control: "text" },
