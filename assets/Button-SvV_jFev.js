import{j as i}from"./jsx-runtime-BkBIjjFT.js";import{r as L}from"./index-KmaxkdDD.js";import{B as h}from"./index-VIbBARS4.js";import{a as l,u as p,p as g,b as n}from"./index-DT8u_GqS.js";import{T as k}from"./Typography-Ck-NcY7i.js";import{S as m}from"./Spinner-oUHXJT3k.js";const v=l.div`
  display: flex;
  flex-direction: row;
  align-items: center;
...
`,C=l.div`
  ${({$variant:t,$isLoading:a})=>{const{tokens:r}=p(),{button:o}=r,{shadow:e}=o.bottomLayer;return[n`
      ...
      `,a&&n`
        ...
        `]}}
`,$=L.forwardRef((t,a)=>{const{variant:r,children:o,testID:e,type:d,isLoading:c,fullWidth:u,...b}=t;return i.jsxs(s,{...b,ref:a,$variant:r,$isLoading:c,$fullWidth:u,"data-testid":e,type:d||"button",children:[i.jsx(C,{$variant:r,$isLoading:c}),i.jsx(j,{$variant:r,$isLoading:c,children:o})]})});$.displayName="ButtonBase";const B=L.forwardRef((t,a)=>{const{text:r,variant:o=h.DEFAULT_VARIANT,startIcon:e,isLoading:d,testID:c="button",...u}=t,{tokens:b}=p(),{button:y}=b,f={"aria-disabled":d?!0:void 0,"aria-label":d?"Loading":void 0};return i.jsx($,{...u,...f,ref:a,variant:o,isLoading:d,testID:c,children:i.jsxs(v,{children:[e&&i.jsx(x,{$isLoading:d,children:e}),i.jsx(w,{$isLoading:d,children:i.jsx(k,{variant:y.topLayer.text.typography.variant,fontFamily:y.topLayer.text.typography.fontFamily,noWrap:!0,color:"inherit",component:"div",testID:`${c}-text`,children:r})}),d&&i.jsx(R,{children:i.jsx(m,{variant:h.SPINNER_VARIANTS[o],testID:`${c}-spinner`})})]})})});B.displayName="Button";export{B};
