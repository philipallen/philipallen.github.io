...
`,co=h.button`
  ${()=>{const{tokens:t}=f(),{tooltip:o}=t;return i`
    ...
    `}}
`,w=l.forwardRef((t,o)=>{const{children:e,...r}=t,{tokens:s}=f(),{tooltip:a}=s,{open:m,setOpen:g,isControlled:c,arrowRef:y,floatingData:u,interactionsData:d}=B(),I=D([u.refs.setFloating,o]);return m?n.jsx(Z,{children:n.jsxs(lo,{ref:I,style:u.floatingStyles,...d.getFloatingProps(r),$isControlled:c,children:[n.jsx(oo,{ref:y,context:u.context,fill:a.backgroundColor,width:parseInt(a.arrow.width),height:parseInt(a.arrow.height)}),c&&n.jsx(co,{onClick:()=>g(!1),"aria-label":"Close tooltip",children:n.jsx(no,{})}),e]})}):null});w.displayName="TooltipContent";w.__docgenInfo={description:"",methods:[],displayName:"TooltipContent"};function N({children:t}){return n.jsx("div",{style:{display:"grid",placeItems:"center",width:"100%",height:350},children:t})}const po={title:"Components/Data Display/Tooltip",component:x,render:function(o){return n.jsx(N,{children:n.jsxs(x,{...o,children:[n.jsx(C,{children:n.jsx(v,{"aria-label":"Button label"})}),n.jsx(w,{children:n.jsx(S,{color:"inherit",children:"APR stands for Annual Percentage Rate. It's the rate you will have to pay for the chosen loan amount."})})]})})},argTypes:{offset:{control:{type:"number"}},placement:{control:{type:"select"},options:T.POSITIONS}},args:{offset:6,placement:T.DEFAULT_POSITION}},$={},b={render:function(o){const[e,r]=l.useState(!1);return n.jsx(N,{children:n.jsxs(x,{...o,open:e,onOpenChange:r,children:[n.jsx(C,{children:n.jsx(v,{"aria-label":"Button label",onClick:()=>r(!e)})}),n.jsx(w,{children:n.jsx(S,{color:"inherit",children:"APR stands for Annual Percentage Rate. It's the rate you will have to pay for the chosen loan amount."})})]})})}};var j,k,P;$.parameters={...$.parameters,docs:{...(j=$.parameters)==null?void 0:j.docs,source:{originalSource:"{}",...(P=(k=$.parameters)==null?void 0:k.docs)==null?void 0:P.source}}};var O,_,F;b.parameters={...b.parameters,docs:{...(O=b.parameters)==null?void 0:O.docs,source:{originalSource:`{
