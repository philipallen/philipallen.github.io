import{j as r}from"./jsx-runtime-6eef64cc.js";import{a as ce}from"./index-583b5bb5.js";import{T as pe,I as de}from"./index-b1e3628a.js";import{g as ue}from"./index-aa3a2926.js";import{r as T}from"./index-c013ead5.js";import{a as x,b,u as I}from"./index-2b4c4340.js";import{T as me}from"./Typography-2ed3318f.js";import{I as he}from"./InputLabelTop-8b2b7093.js";import{I as ge,a as xe}from"./InputAlert-a383ad59.js";import{O as be,C as Ie}from"./CharactersCounter-40865d51.js";const ae=x(he)`
  ${()=>b`
      width: 100%;
    `}
`,fe=x.div`
  ${()=>{const{tokens:t}=I(),{textInput:e}=t;return b`
    ...
    `}}
`,Te=x.input`
  ${()=>{const{tokens:t}=I(),{textInput:e,typography:o}=t,n=e.typographyVariant;return b`
      width: 100%;
      background: none;
      padding: 0;
      border: none;
      ...
      color: ${e.color.base};
      font-family: ${o.fontFamily[n]};
      font-size: ${o.fontSize[n]};
      line-height: ${o.lineHeight[n]};
...
}`,...(te=(re=g.parameters)==null?void 0:re.docs)==null?void 0:te.source}}};const Se=["Basic","WithLabel","WithHint","WithPrefix","WithIcon","WithLimit","WithError","Disabled","ReadOnly"],He=Object.freeze(Object.defineProperty({__proto__:null,Basic:a,Disabled:h,ReadOnly:g,WithError:m,WithHint:c,WithIcon:d,WithLabel:l,WithLimit:u,WithPrefix:p,__namedExportsOrder:Se,default:$e},Symbol.toStringTag,{value:"Module"}));export{a as B,h as D,g as R,He as T,l as W,c as a,p as b,d as c,u as d,m as e};
