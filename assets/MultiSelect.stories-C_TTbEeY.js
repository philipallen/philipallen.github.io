import{j as r}from"./jsx-runtime-DQ32znRX.js";import{f as q}from"./index-Cnk2rnxF.js";import{S as A}from"./index-BGt6MgUo.js";import{r as M}from"./index-DH5ua8nC.js";import{u as g,S as R,M as N}from"./SelectBase-DPBnt8zN.js";import{a as m,u as d,b as s}from"./index-jNFq1OWt.js";import{I as X}from"./InputWrapper-B7dHgQQ8.js";import{I as J}from"./InlineAlert-CT5-H_YI.js";import{I as K}from"./InputLabelTop-DA_PelCW.js";import{T as b}from"./Typography-D5AcRl6x.js";import{C as z}from"./CheckboxBase-C-HThyU3.js";const G=m.div`
  overflow: hidden;
`,U=m.div`
...
`,Q=m.div`
  ${({$isSelected:n,$isHighlighted:e})=>{const{tokens:a}=d(),{multiSelect:t}=a;return[s`
      ...
      `,n&&s`
        ...
        `]}}
`;function Z(n){return n?n.title:""}function ee(n,e){const{changes:a,type:t}=e;switch(t){case g.stateChangeTypes.ToggleButtonKeyDownEnter:case g.stateChangeTypes.ToggleButtonKeyDownSpaceButton:case g.stateChangeTypes.ItemClick:return{...a,isOpen:!0,highlightedIndex:n.highlightedIndex};default:return a}}function te(n,e){var a;return n.length===e.length?"All":e.length===1?(a=e[0])==null?void 0:a.title:e.length>1?`${e.length} items selected`:"None"}function y(n){const{labelProps:e,heading:a,selectedItems:t,onChange:o,alertProps:f,testID:v="multi-select",...T}=n,{items:x}=T,{tokens:$}=d(),{multiSelect:l}=$,{getLabelProps:B,getToggleButtonProps:D,getMenuProps:W,isOpen:_,getItemProps:O,highlightedIndex:F}=g({items:x,itemToString:Z,selectedItem:null,stateReducer:ee,onSelectedItemChange:({selectedItem:u})=>{if(!u)return;const i=t.indexOf(u);i>0?o([...t.slice(0,i),...t.slice(i+1)]):o(i===0?[...t.slice(1)]:[...t,u])}}),I=M.useId(),{labelHint:L}=e;return r.jsx(X,{alert:f?r.jsx(J,{...f,testID:`${v}-alert`}):void 0,children:r.jsx(K,{...e,...B(),labelHintID:I,children:r.jsx(R,{...T,toggleButtonProps:{"aria-describedby":L?I:void 0},getToggleButtonProps:D,getMenuProps:W,isOpen:_,renderButtonContent:()=>r.jsxs(G,{children:[r.jsx(U,{children:r.jsx(b,{component:"div",color:"inherit",variant:l.button.headingText.typography.variant,fontFamily:l.button.headingText.typography.fontFamily,noWrap:!0,children:a})}),r.jsx(V,{children:r.jsx(b,{component:"div",color:"inherit",variant:l.button.selectedText.typography.variant,fontFamily:l.button.selectedText.typography.fontFamily,noWrap:!0,children:te(x,t)})})]}),renderListItem:(u,i,P)=>{const h=t.includes(i),S=F===P;return r.jsx(Y,{...O({ref:u,item:i,index:P,"aria-selected":h}),"data-hovered":S||void 0,children:r.jsxs(Q,{$isSelected:h,$isHighlighted:S,children:[r.jsx(z,{inert:"",value:i.title,checked:h,onChange:()=>null}),r.jsx(b,{component:"div",color:"inherit",title:i.title,variant:l.menu.option.inner.text.typography.variant,fontFamily:l.menu.option.inner.text.typography.fontFamily,noWrap:!0,children:i.title})]})},i.id)},maxListHeight:N,testID:v})})})}y.__docgenInfo={description:"",methods:[],displayName:"MultiSelect",props:{labelProps:{required:!0,tsType:{name:"Omit",elements:[{name:"intersection",raw:`Omit<
...
>`},description:""},heading:{required:!0,tsType:{name:"string"},description:""},selectedItems:{required:!0,tsType:{name:"Array",elements:[{name:"T"}],raw:"T[]"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(selectedItems: T[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"T"}],raw:"T[]"},name:"selectedItems"}],return:{name:"void"}}},description:""},alertProps:{required:!1,tsType:{name:"intersection",raw:`PropsWithOptionalTestID & {
  ...
  severity: AlertSeverity;
  children: string;
}`,signature:{properties:[{key:"severity",value:{name:"AlertSeverity",required:!0}},{key:"children",value:{name:"string",required:!0}}]}}]},description:""}}};const{useArgs:ne}=__STORYBOOK_MODULE_PREVIEW_API__,re={title:"Components/Inputs/MultiSelect",component:y,render:function(e){const[,a]=ne();function t(o){e.onChange(o),a({selectedItems:o})}return r.jsx("div",{style:{height:400},children:r.jsx(y,{...e,onChange:t})})},argTypes:{heading:{type:"string"},hasError:{type:"boolean"}},args:{onChange:q(),heading:"Heading",items:A.mockItems,selectedItems:[],hasError:!1}},p={args:{labelProps:{"aria-label":"Label"}}},c={args:{hasError:!0,labelProps:{"aria-label":"Label"},alertProps:{severity:"error",children:"Error description over two lines if required."}}};var k,C,H;p.parameters={...p.parameters,docs:{...(k=p.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
    labelProps: {
      "aria-label": "Label"
    }
  }
}`,...(H=(C=p.parameters)==null?void 0:C.docs)==null?void 0:H.source}}};var w,j,E;c.parameters={...c.parameters,docs:{...(w=c.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    hasError: true,
    labelProps: {
      "aria-label": "Label"
...
}`,...(E=(j=c.parameters)==null?void 0:j.docs)==null?void 0:E.source}}};const ae=["Basic","WithError"],be=Object.freeze(Object.defineProperty({__proto__:null,Basic:p,WithError:c,__namedExportsOrder:ae,default:re},Symbol.toStringTag,{value:"Module"}));export{p as B,be as M,c as W};
