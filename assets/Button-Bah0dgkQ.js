import{j as i}from"./jsx-runtime-DQ32znRX.js";import{r as L}from"./index-DH5ua8nC.js";import{B as m}from"./index-BrtwDHqb.js";import{a as l,u as p,p as g,b as n}from"./index-CzvSJj6w.js";import{T as k}from"./Typography-RMDmhaRB.js";import{S as v}from"./Spinner-DKaTyvrv.js";const x=l.div`
  display: flex;
  flex-direction: row;
  align-items: center;
...
`,R=l.div`
  ${({$variant:t,$isLoading:a})=>{const{tokens:r}=p(),{button:o}=r,{shadow:e}=o.bottomLayer;return[n`
      ...
      `,a&&n`
        ...
        `]}}
`,y=L.forwardRef((t,a)=>{const{variant:r,children:o,testID:e,type:d,isLoading:c,fullWidth:u,...b}=t;return i.jsxs(s,{...b,ref:a,$variant:r,$isLoading:c,$fullWidth:u,"data-testid":e,type:d||"button",children:[i.jsx(R,{$variant:r,$isLoading:c}),i.jsx(C,{$variant:r,$isLoading:c,children:o})]})});y.displayName="ButtonBase";y.__docgenInfo={description:"",methods:[],displayName:"ButtonBase"};const $=L.forwardRef((t,a)=>{const{text:r,variant:o="primary",startIcon:e,isLoading:d,testID:c="button",...u}=t,{tokens:b}=p(),{button:h}=b,f={"aria-disabled":d,"aria-label":d?"Loading":void 0};return i.jsx(y,{...u,...f,ref:a,variant:o,isLoading:d,testID:c,children:i.jsxs(x,{children:[e&&i.jsx(w,{$isLoading:d,children:e}),i.jsx(B,{$isLoading:d,children:i.jsx(k,{variant:h.topLayer.text.typography.variant,fontFamily:h.topLayer.text.typography.fontFamily,noWrap:!0,color:"inherit",component:"div",testID:`${c}-text`,children:r})}),d&&i.jsx(j,{children:i.jsx(v,{variant:m.SPINNER_VARIANTS[o],testID:`${c}-spinner`})})]})})});$.displayName="Button";$.__docgenInfo={description:"",methods:[],displayName:"Button"};export{$ as B};
