import{j as e}from"./jsx-runtime-DQ32znRX.js";import{D as W,L as E,e as I}from"./index-CPadiX42.js";import{g as f}from"./index-BgzBzW_7.js";import{r as B}from"./index-DH5ua8nC.js";import{a as c,u as i,b as l,p as z}from"./index-BSpjoQIR.js";import{L as C}from"./LinkBase-DTFnEDQb.js";import{T as O}from"./Typography-Dx-yaUty.js";const _=c(C)``,p=c.div`
...
`,k=c.div`
  ${()=>{const{tokens:n}=i(),{link:o}=n,a=z(o.withIcon.size);return l`
    ...
    `}}
`,h=B.forwardRef((n,o)=>{const{children:a,startIcon:m,endIcon:g,testID:d="link",...D}=n,{tokens:T}=i(),{link:u}=T;return e.jsx(_,{...D,ref:o,display:"inline-flex",testID:d,children:e.jsxs(p,{children:[m&&e.jsx(k,{"data-testid":`${d}-start-icon-wrapper`,children:m}),e.jsx(F,{component:"span",color:"inherit",variant:u.typography.variant,fontFamily:u.typography.fontFamily,children:a}),g&&e.jsx(k,{"data-testid":`${d}-end-icon-wrapper`,children:g})]})})});h.displayName="LinkWithIcon";h.__docgenInfo={description:"",methods:[],displayName:"LinkWithIcon"};const N={title:"Components/Inputs/LinkWithIcon",component:h,argTypes:{href:{control:{type:"text"}},startIcon:{...f(I),if:{arg:"endIcon",truthy:!1}},endIcon:{...f(I),if:{arg:"startIcon",truthy:!1}}},args:{href:"#"}},t={args:{children:"Download report"}},r={args:{children:"Download report",startIcon:e.jsx(W,{})}},s={args:{children:"Log in",endIcon:e.jsx(E,{})}};var x,y,$;t.parameters={...t.parameters,docs:{...(x=t.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
