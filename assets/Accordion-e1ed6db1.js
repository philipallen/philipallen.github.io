import{j as t}from"./jsx-runtime-6eef64cc.js";import{r as p}from"./index-c013ead5.js";import{A as O}from"./index-f15beae1.js";import{a,u as n,b as i}from"./index-912b60f4.js";import{a as T}from"./index-5cf7436a.js";import{T as w}from"./Typography-7961d08c.js";const j=a.div`
  ${({$variant:r})=>{const{tokens:o}=n(),{accordion:e}=o;return[i`
        display: grid;
      ...
      `]}}
`,s=a.button`
  ${()=>{const{tokens:r}=n(),{accordion:o}=r;return[i`
        all: unset;
        position: relative;
        display: grid;
...
`,A=a.div`
  ${({$variant:r})=>{const{tokens:o}=n(),{accordion:e}=o;return[i`
      ...
      `]}}
`,I=a.div`
  ${({$isOpen:r})=>{const{tokens:o}=n(),{accordion:e}=o;return[i`
...
`,q=a.div`
  ${({$isOpen:r})=>{const{tokens:o}=n(),{accordion:e}=o;return[i`
      ...
      `]}}
`,R=a.div`
  ${({hidden:r})=>{const{tokens:o}=n(),{accordion:e}=o;return[i`
        display: ${r?"none":"block"};
        padding: ${e.content.padding};
      `]}}
`;function D(r){const{title:o,content:e,isOpen:$,initialOpen:m=!1,onChange:b,variant:c=O.DEFAULT_VARIANT,headingLevel:f=3,testID:l="accordion"}=r,h=p.useId(),u=p.useId(),{tokens:v}=n(),{accordion:g}=v,[y,k]=p.useState(m),d=$??y,x=b??k;function C(){x(!d)}return t.jsxs(j,{$variant:c,"data-testid":l,children:[t.jsxs(s,{id:h,type:"button",onClick:C,"aria-expanded":d,"aria-controls":u,"data-testid":`${l}-header`,children:[t.jsxs(A,{$variant:c,children:[t.jsx(w,{color:"inherit",component:`h${f}`,fontFamily:g.header.text.fontFamily,variant:g.header.text.typographyVariant[c],noWrap:!0,children:o}),t.jsx(I,{$isOpen:d,children:t.jsx(T,{})})]}),t.jsx(q,{$isOpen:d})]}),t.jsx(R,{id:u,role:"region",hidden:!d,"aria-labelledby":h,"data-testid":`${l}-content`,children:e})]})}D.__docgenInfo={description:"",methods:[],displayName:"Accordion",props:{title:{required:!0,tsType:{name:"string"},description:""},content:{required:!0,tsType:{name:"JSX.Element"},description:""},isOpen:{required:!1,tsType:{name:"boolean"},description:""},initialOpen:{required:!1,tsType:{name:"boolean"},description:""},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(isOpen: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"isOpen"}],return:{name:"void"}}},description:""},variant:{required:!1,tsType:{name:"CoreAccordion.Variant"},description:""},headingLevel:{required:!1,tsType:{name:"CoreAccordion.HeadingLevel"},description:""}}};export{D as A};
