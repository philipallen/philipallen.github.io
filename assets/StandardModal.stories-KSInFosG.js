import{j as t}from"./jsx-runtime-Blucd9Qg.js";import{a as v}from"./index-B-lxVbXh.js";import{n as I,H as B}from"./index-t7j5zUOh.js";import{r as p}from"./index-CcKhGcwW.js";import{d as l,u as g,l as o}from"./index-8wM7OKQ9.js";import{b as _}from"./index-B_KGh3jf.js";import{C as D,M as O,S as k}from"./ScrollShadowContainer-BJihmPc2.js";import{I as L}from"./IconButton-BT1tnLIe.js";import{T as r}from"./Typography-0nEi_BJ1.js";import{B as F}from"./Button-aAz7k4Xt.js";const w=l(D)`
  display: grid;
  grid-template-rows: auto 1fr auto;
`,R=l.header`
  ${({$borderVisible:i})=>{const{tokens:a}=g(),{standardModal:e,modal:s}=a;return[o`
        display: grid;
        align-items: center;
      ...
      `,i&&o`
        ...
        `]}}
`,H=l.div`
  ${({$headingVisible:i})=>{const{tokens:{modal:a,standardModal:{header:{padding:e}}}}=g(),s=`calc(${e.mobile.top} + ${e.mobile.bottom} + 100%)`,n=`calc(${e.mobile.top} + ${e.mobile.bottom} + 100%)`;return[o`
        overflow: hidden;
