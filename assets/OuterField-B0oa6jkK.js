import{j as t}from"./jsx-runtime-sfY7k0Xq.js";import{a as r,u as s,b as i}from"./index-DmICCP6d.js";const n=r.div`
  ${()=>{const{tokens:e}=s(),{outerField:o}=e;return i`
...
`,a=r.div`
  ${()=>{const{tokens:e}=s(),{outerField:o}=e;return i`
    ...
    `}}
`;function d(e){const{children:o}=e;return t.jsx(n,{children:t.jsx(a,{children:o})})}export{d as O};
