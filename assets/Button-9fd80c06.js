import{a as i,u as d,p as b,b as a,j as s}from"./index-74fe31d7.js";import{r as y}from"./index-c013ead5.js";import{T as g}from"./Typography-5c86d7b4.js";const $=i.div`
  display: flex;
  flex-direction: row;
  align-items: center;
...
`,m=i.div`
  ${({$variant:t})=>{const{tokens:r}=d(),{button:o}=r,{shadow:e}=o.bottomLayer;return a`
    ...
    `}}
`,k=y.forwardRef((t,r)=>{const{variant:o,children:e,testID:c,type:l,fullWidth:p,...u}=t;return s.jsxs(n,{...u,ref:r,$variant:o,$fullWidth:p,"data-testid":c,type:l||"button",children:[s.jsx(m,{$variant:o}),s.jsx(L,{$variant:o,children:e})]})}),j=y.forwardRef((t,r)=>{const{text:o,variant:e="primary",startIcon:c,testID:l="button",...p}=t,{tokens:u}=d(),{button:h}=u;return s.jsx(k,{...p,ref:r,variant:e,testID:l,children:s.jsxs($,{children:[c&&s.jsx(f,{children:c}),s.jsx(g,{fontFamily:h.topLayer.text.fontFamily,variant:h.topLayer.text.typographyVariant,noWrap:!0,color:"inherit",testID:`${l}-text`,children:o})]})})});export{j as B};
