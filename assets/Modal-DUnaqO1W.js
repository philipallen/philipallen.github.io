import{j as s}from"./jsx-runtime-sfY7k0Xq.js";import{r as a}from"./index-CcKhGcwW.js";import{a as x}from"./FocusScope-DImX_wcQ.js";import{O as v}from"./OverlayContext-DE6V0lcf.js";import{a as h,u as m,b as u}from"./index-D1OOBdzz.js";import{m as k}from"./utils-BPOuYIA2.js";import{$ as E}from"./usePreventScroll-XlKO3Wry.js";let n=typeof document<"u"&&window.visualViewport;function y(){let i=k(),[e,t]=a.useState(()=>i?{width:0,height:0}:b());return a.useEffect(()=>{let o=()=>{t(r=>{let d=b();return d.width===r.width&&d.height===r.height?r:d})};return n?n.addEventListener("resize",o):window.addEventListener("resize",o),()=>{n?n.removeEventListener("resize",o):window.removeEventListener("resize",o)}},[]),e}function b(){return{width:n&&(n==null?void 0:n.width)||window.innerWidth,height:n&&(n==null?void 0:n.height)||window.innerHeight}}const j=h.dialog`
