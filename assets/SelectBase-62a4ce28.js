...
`,Bn=j.ul`
  ${()=>{const{tokens:e}=Q(),{select:t}=e,{menu:{scrollBar:{thumbColor:r,trackColor:o,radius:n}}}=t;return M`
    ...
    `}}
`;function Hn(e){const{offsetValue:t}=e,{refs:r,floatingStyles:o}=Ct({placement:"bottom-start",whileElementsMounted:Rt,middleware:[Ot(t),Bt({padding:16}),Ht({apply({rects:n,elements:u}){Object.assign(u.floating.style,{minWidth:`${n.reference.width}px`})}})]});return{refs:r,floatingStyles:o}}function Kn(e){const{isOpen:t}=e,r={threshold:1},o=d.useRef(null),n=d.useRef(null),[u,s]=d.useState(!1),[i,a]=d.useState(!1);function m(h,T){if(!(h.length<2)){if(T===0)return o;if(h.length===T+1)return n}}return d.useEffect(()=>{if(!t||!o.current||!n.current)return;const h=new IntersectionObserver(([y])=>{y&&s(!y.isIntersecting)},r),T=new IntersectionObserver(([y])=>{y&&a(!y.isIntersecting)},r);return h.observe(o.current),T.observe(n.current),()=>{h.disconnect(),T.disconnect()}},[t]),{getListItemRef:m,showTopShadow:u,showBottomShadow:i}}function Ln(e){const{getToggleButtonProps:t,getMenuProps:r,isOpen:o,items:n,toggleButtonProps:u,renderButtonContent:s,renderListItem:i,hasError:a,isDisabled:m,maxListHeight:h,testID:T="select"}=e,{tokens:y}=Q(),{select:w}=y,{refs:p,floatingStyles:D}=Hn({offsetValue:parseInt(w.gap,10)}),{getListItemRef:I,showTopShadow:x,showBottomShadow:z}=Kn({isOpen:o});return V.jsxs(V.Fragment,{children:[V.jsx(Sn,{children:V.jsx(En,{...u,...t({ref:p.setReference,disabled:m}),$isOpen:o,$hasError:a,$isDisabled:m,"data-testid":T,children:V.jsxs(kn,{children:[s(),V.jsx(Mn,{children:o?V.jsx(Dn,{"aria-hidden":"true"}):V.jsx($t,{"aria-hidden":"true"})})]})})}),V.jsxs(Cn,{...r({ref:p.setFloating}),style:D,$isOpen:o,children:[V.jsx(Rn,{$visible:x}),V.jsx(Bn,{style:{maxHeight:h},children:o&&n.map((q,C)=>i(I(n,C),q,C))}),V.jsx(On,{$visible:z})]})]})}Ln.__docgenInfo={description:"",methods:[],displayName:"SelectBase",props:{items:{required:!0,tsType:{name:"Array",elements:[{name:"T"}],raw:"T[]"},description:""},toggleButtonProps:{required:!1,tsType:{name:"Pick",elements:[{name:"ComponentPropsWithoutRef",elements:[{name:"literal",value:'"div"'}],raw:'ComponentPropsWithoutRef<"div">'},{name:"literal",value:'"aria-describedby"'}],raw:`Pick<
  ComponentPropsWithoutRef<"div">,
  "aria-describedby"
>`},description:""},renderButtonContent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => JSX.Element",signature:{arguments:[],return:{name:"JSX.Element"}}},description:""},renderListItem:{required:!0,tsType:{name:"signature",type:"function",raw:"(ref: any, item: T, index: number) => JSX.Element",signature:{arguments:[{type:{name:"any"},name:"ref"},{type:{name:"T"},name:"item"},{type:{name:"number"},name:"index"}],return:{name:"JSX.Element"}}},description:""},hasError:{required:!1,tsType:{name:"boolean"},description:""},isDisabled:{required:!1,tsType:{name:"boolean"},description:""},maxListHeight:{required:!1,tsType:{name:"number"},description:""}}};export{Un as M,Ln as S,yn as u};
