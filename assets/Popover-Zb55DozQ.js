import{j as a}from"./jsx-runtime-sfY7k0Xq.js";import{a as i,u as s,b as n}from"./index-5VPm3mt9.js";import{e as h}from"./index-jIEI4ct_.js";import{b as p,a as $}from"./Dialog-BBveVv4I.js";import{u as m}from"./OverlayContext-DE6V0lcf.js";const f=i(h)`
  ${()=>{const{tokens:e}=s(),{select:o}=e;return n`
    ...
    `}}
`;function H(){return a.jsx(f,{"aria-hidden":"true"})}const x=i(p)`
  ${({$width:e})=>{const{tokens:{select:o,scrollBar:{thumbColor:t,trackColor:r}}}=s();return[n`
      ...
      `,e&&n`
          width: ${e}px;
        `]}}
`,I=6,g=2,T=48,v=T*I,w=g+v;function B(e){const{width:o,isOpen:t,onOpenChange:r,triggerRef:d,...l}=e,{tokens:u}=s(),{select:b}=u,{portalElement:c}=m();return a.jsx($,{getContainer:c&&(()=>c),children:a.jsx(x,{$width:o,maxHeight:w,offset:parseInt(b.gap,10),isOpen:t,onOpenChange:r,triggerRef:d,...l})})}export{H as C,w as M,B as P};
