import{j as s}from"./jsx-runtime-sfY7k0Xq.js";import{r as p}from"./index-CcKhGcwW.js";import{I as $}from"./index-HXCmP3Qs.js";import{a as c,u as d,b as i}from"./index-5VPm3mt9.js";import{$ as f}from"./Button-CUYx7hLe.js";const e=c(f)`
...
`,b=c.div`
  ${({$variant:n})=>{const{tokens:t}=d(),{iconButton:o}=t;return[i`
      ...
      `,n==="contained"&&i`
        ...
        `]}}
`,g=p.forwardRef((n,t)=>{const{variant:o=$.DEFAULT_VARIANT,children:r,testID:a="icon-button",...l}=n;return s.jsx(e,{...l,ref:t,$variant:o,"data-testid":a,children:u=>s.jsx(b,{$variant:o,children:typeof r=="function"?r(u):r})})});g.displayName="IconButton";export{g as I};
