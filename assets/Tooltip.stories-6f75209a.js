import{j as o}from"./jsx-runtime-6eef64cc.js";import{r as s}from"./index-c013ead5.js";import{c as x}from"./index-f9a152de.js";import{b as E,c as F,s as N,d as q,e as M,f as U,g as W,h as z,o as L,i as H,j as V,k as G,u as b,F as J,a as K}from"./floating-ui.react-06582175.js";import{a as Q,u as I,b as X}from"./index-2b4c4340.js";import{B as _}from"./Button-d114bdbe.js";import{T as v}from"./Typography-45ec0b3f.js";function Y({initialOpen:t=!1,placement:e=x.DEFAULT_POSITION,open:n,onOpenChange:r}={}){const[d,p]=s.useState(t),l=n??d,c=r??p,a=s.useRef(null),i=E({placement:e,open:l,onOpenChange:c,whileElementsMounted:z,middleware:[L(16),H({padding:5}),V({padding:5}),G({element:a})]}),T=F(i.context,{handleClose:N(),enabled:n===void 0}),k=q(i.context,{enabled:n===void 0}),A=M(i.context),B=U(i.context,{role:"tooltip"}),y=W([T,k,A,B]);return s.useMemo(()=>({open:l,setOpen:c,arrowRef:a,floatingData:i,interactionsData:y}),[l,c,a,i,y])}const S=s.createContext(null),D=()=>{const t=s.useContext(S);if(!t)throw new Error("Tooltip components must be wrapped in <Tooltip />");return t};function f(t){const{children:e,...n}=t,r=Y(n);return o.jsx(S.Provider,{value:r,children:e})}f.__docgenInfo={description:"",methods:[],displayName:"Tooltip",props:{initialOpen:{required:!1,tsType:{name:"boolean"},description:""},placement:{required:!1,tsType:{name:"CoreTooltip.Position"},description:""},open:{required:!1,tsType:{name:"boolean"},description:""},onOpenChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(open: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"open"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"ReactNode"},description:""}}};const m=s.forwardRef((t,e)=>{const{children:n,...r}=t,{open:d,floatingData:p,interactionsData:l}=D(),c=n.ref,a=b([p.refs.setReference,c,e]);return s.isValidElement(n)?s.cloneElement(n,l.getReferenceProps({ref:a,...r,...n.props,"data-state":d?"open":"closed"})):null});m.displayName="TooltipTrigger";m.__docgenInfo={description:"",methods:[],displayName:"TooltipTrigger"};const Z=Q.div`
