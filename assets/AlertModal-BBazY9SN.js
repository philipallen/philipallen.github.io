import{j as i}from"./jsx-runtime-sfY7k0Xq.js";import{i as g}from"./index-HXCmP3Qs.js";import{a as c,u as p,b as d}from"./index-5VPm3mt9.js";import{E,W as B,g as F,h as L}from"./index-jIEI4ct_.js";import{C as T,M as I,S as _}from"./ScrollShadowContainer-B908Hbcq.js";import{r as f}from"./index-CcKhGcwW.js";import{T as S}from"./Typography-CWLzUOZE.js";import{B as A}from"./Button-4SDqA0z4.js";const P=c(T)`
  display: grid;
...
`,U=c.div`
  ${({$layout:e,$stickFooter:a})=>{const{tokens:o}=p(),{alertModal:t,modal:n}=o;return[d`
      ...
      `,a&&d`
        ...
        `]}}
`;function u(){const{tokens:e}=p(),{modal:a}=e,o=window.matchMedia(`(min-width: ${a.breakpoints.tablet})`),[t,n]=f.useState(()=>o.matches);return f.useEffect(()=>{function l(r){n(r.matches)}return o.addEventListener("change",l),()=>{o.removeEventListener("change",l)}},[]),{isMobile:!t}}function R(e,a,o){const{isMobile:t}=u(),n=(a||[]).map(s=>({...s,variant:"primary"})),l=(o||[]).map(s=>({...s,variant:"secondary"})),r=[];return t||e==="stacked"?r.push(...n.reverse(),...l.reverse()):r.push(...l,...n),{orderedButtonsProps:r}}function J(e){const{heading:a,headingLevel:o=g.DEFAULT_HEADING_LEVEL,severity:t=g.DEFAULT_SEVERITY,primaryButtonsProps:n,secondaryButtonsProps:l,footerLayout:r=g.DEFAULT_FOOTER_LAYOUT,hasStickyFooter:s=!1,children:y,testID:k="alert-modal",...m}=e,{isOpen:v}=m,{tokens:w}=p(),{alertModal:h}=w,x={error:i.jsx(E,{}),warning:i.jsx(B,{}),success:i.jsx(F,{}),info:i.jsx(L,{})},{isMobile:M}=u(),{orderedButtonsProps:j}=R(r,n,l),b=i.jsx("div",{children:i.jsx(U,{$layout:M?"stacked":r,$stickFooter:s,children:j.map($=>i.jsx(A,{...$},$.children))})});return i.jsx(I,{"aria-label":a,testID:k,...m,children:v&&i.jsxs(P,{children:[i.jsxs(C,{$severity:t,children:[i.jsx(D,{$severity:t,children:x[t]}),i.jsx(S,{component:`h${o}`,variant:h.heading.typography.variant,fontFamily:h.heading.typography.fontFamily,children:a})]}),i.jsxs(_,{children:[i.jsx(O,{$stickFooter:s,children:y}),s?void 0:b]}),s?b:void 0]})})}export{J as A};
