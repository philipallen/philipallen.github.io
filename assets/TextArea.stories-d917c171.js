import{f as be}from"./index-6eef940f.js";import{j as i}from"./jsx-runtime-6eef64cc.js";import{r as l}from"./index-c013ead5.js";import{b as he}from"./index-f3e1dd3b.js";import{i as ge}from"./react-textarea-autosize.browser.esm-ede8cc8b.js";import{a as v,b as w,u as re,p as k}from"./index-7d8df789.js";import{I as fe}from"./InputLabelTop-3732bf72.js";import{I as xe,a as ye}from"./InputAlert-8926eb33.js";import{O as we,C as Te}from"./CharactersCounter-a29993f6.js";const ae=v(fe)`
  ${()=>w`
      width: 100%;
    `}
`,ve=v.div`
  ...
  ${({$displayInnerShadow:o})=>{const{tokens:e}=re(),{textArea:t,outerField:r}=e;return w`
      &::before,
      &::after {
        content: "";
        position: absolute;
    ...
    `}}
`,Pe=v(ge)`
  ${()=>{const{tokens:o}=re(),{textArea:e,typography:t,scrollBar:r,outerField:T}=o,s=e.typography.variant,c=k(t.fontSize[s]),p=k(t.lineHeight[s]);return w`
      all: unset;
...
}`,...(D=(C=a.parameters)==null?void 0:C.docs)==null?void 0:D.source}}};var W,E,q;d.parameters={...d.parameters,docs:{...(W=d.parameters)==null?void 0:W.docs,source:{originalSource:`{
  ...Basic,
  args: {
    labelProps: {
...
}`,...(q=(E=d.parameters)==null?void 0:E.docs)==null?void 0:q.source}}};var B,F,j;b.parameters={...b.parameters,docs:{...(B=b.parameters)==null?void 0:B.docs,source:{originalSource:`{
  ...Basic,
  args: {
    labelProps: {
      label: "Label for TextArea"
...
}`,...(ee=(Z=y.parameters)==null?void 0:Z.docs)==null?void 0:ee.source}}};const Le=["Basic","AutoGrow","WithLabel","WithHint","WithLimit","WithError","Disabled","ReadOnly"],Ee=Object.freeze(Object.defineProperty({__proto__:null,AutoGrow:d,Basic:a,Disabled:x,ReadOnly:y,WithError:f,WithHint:h,WithLabel:b,WithLimit:g,__namedExportsOrder:Le,default:Ie},Symbol.toStringTag,{value:"Module"}));export{d as A,a as B,x as D,y as R,Ee as T,b as W,h as a,g as b,f as c};
