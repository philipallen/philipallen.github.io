import{j as i}from"./jsx-runtime-BkBIjjFT.js";import{r as g}from"./index-KmaxkdDD.js";import{B as f}from"./index-DYe-GrfV.js";import{a as l,u as p,p as h,b as n}from"./index-ByEiyUmp.js";import{T as m}from"./Typography-C-GpEjPp.js";import{S as k}from"./Spinner-CJtYfVLD.js";const v=l.div`
  display: flex;
  flex-direction: row;
  align-items: center;
  ...
  overflow: hidden;
`,x=l.span`
  ${({$isLoading:t})=>{const{tokens:a}=p(),{button:r}=a,o=h(r.topLayer.icon.width),e=h(r.topLayer.icon.width);return n`
      display: flex;
      flex-shrink: 0;
...
`,R=l.div`
  ${({$variant:t,$isLoading:a})=>{const{tokens:r}=p(),{button:o}=r,{shadow:e}=o.bottomLayer;return[n`
      ...
      `,a&&n`
        ...
        `]}}
`,L=g.forwardRef((t,a)=>{const{variant:r,children:o,testID:e,type:d,isLoading:c,fullWidth:u,...b}=t;return i.jsxs(s,{...b,ref:a,$variant:r,$isLoading:c,$fullWidth:u,"data-testid":e,type:d||"button",children:[i.jsx(R,{$variant:r,$isLoading:c}),i.jsx(C,{$variant:r,$isLoading:c,children:o})]})});L.displayName="ButtonBase";const B=g.forwardRef((t,a)=>{const{text:r,variant:o="primary",startIcon:e,isLoading:d,testID:c="button",...u}=t,{tokens:b}=p(),{button:y}=b,$={"aria-disabled":d?!0:void 0,"aria-label":d?"Loading":void 0};return i.jsx(L,{...u,...$,ref:a,variant:o,isLoading:d,testID:c,children:i.jsxs(v,{children:[e&&i.jsx(x,{$isLoading:d,children:e}),i.jsx(w,{$isLoading:d,children:i.jsx(m,{variant:y.topLayer.text.typography.variant,fontFamily:y.topLayer.text.typography.fontFamily,noWrap:!0,color:"inherit",component:"div",testID:`${c}-text`,children:r})}),d&&i.jsx(j,{children:i.jsx(k,{variant:f.SPINNER_VARIANTS[o],testID:`${c}-spinner`})})]})})});B.displayName="Button";export{B};
