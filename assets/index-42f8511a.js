import{r as p}from"./index-c013ead5.js";import{T as B,B as oo}from"./index-7aa2f780.js";import{a,u as s,p as b,b as n,h as to}from"./index-22f9e29b.js";import{j as l}from"./jsx-runtime-6eef64cc.js";import{C as eo,a as ro,M as no,T as F,b as io}from"./index-b1e3628a.js";import{u as R,F as ao,a as so}from"./floating-ui.react-06582175.js";import{i as lo}from"./react-textarea-autosize.browser.esm-05f9ff93.js";var co=a.div`
  ...
  overflow: hidden;
`,uo=a.span`
  ${({$isLoading:t})=>{const{tokens:o}=s(),{button:e}=o,r=b(e.topLayer.icon.width),i=b(e.topLayer.icon.width);return n`
      display: flex;
      flex-shrink: 0;
...
`,go=a.div`
  ${({$variant:t,$isLoading:o})=>{const{tokens:e}=s(),{button:r}=e,{shadow:i}=r.bottomLayer;return[n`
      ...
      `,o&&n`
        ...
        `]}}
`,D=p.forwardRef((t,o)=>{const{variant:e,children:r,testID:i,type:d,isLoading:c,fullWidth:u,...h}=t;return l.jsxs($,{...h,ref:o,$variant:e,$fullWidth:u,"data-testid":i,type:d||"button",children:[l.jsx(go,{$variant:e,$isLoading:c}),l.jsx(bo,{$variant:e,$isLoading:c,children:r})]})});D.displayName="ButtonBase";var $o=D,fo=a.p`
  ${({$variant:t,$fontFamily:o,$noWrap:e,$color:r})=>{const{tokens:i}=s(),{typography:d,fontFamily:c}=i,u=b(d.fontSize[t]),h=b(d.lineHeight[t]);return[n`
        margin: 0;
        font-weight: normal;
        color: ${r||d.color[t]};
        font-size: ${u};
...
`,zo=a.div`
  ${()=>{const{tokens:t}=s(),{inputAlert:o}=t,e=b(o.iconWrapper.height);return n`
      ...
      height: ${e};
    `}}
`;function So(t){const{severity:o,children:e,testID:r="input-alert"}=t;return l.jsxs(Bo,{role:"alert","aria-live":"polite",$severity:o,"data-testid":r,children:[l.jsx(zo,{children:l.jsx(ro,{"aria-hidden":"true"})}),l.jsx(g,{color:"inherit",children:e})]})}var W=So,Fo=a.label`
...
`,Do=a.span`
  ${()=>{const{tokens:t}=s(),{inputLabelRight:o}=t;return n`
    ...
    `}}
`;function Oo(t){const{label:o,children:e,...r}=t,{tokens:i}=s(),{inputLabelRight:d}=i;return l.jsxs(Fo,{...r,children:[l.jsx("span",{children:e}),o&&l.jsx(Do,{children:l.jsx(g,{component:"span",color:"inherit",fontFamily:d.label.fontFamily,variant:d.label.typographyVariant,children:o})})]})}var N=Oo,L=a.div`
...
`,Zo=a.div`
  ${()=>{const{tokens:t}=s(),{fontFamily:o,themeColor:e}=t;return[n`
        ...
        width: 100%;
      `]}}
`,qo=({elementId:t,labelId:o,labelText:e,errorText:r,children:i,labelTestId:d,...c})=>l.jsxs(Xo,{...A(c),children:[e?l.jsx(g,{id:o,component:"label",htmlFor:t,testID:d,children:e}):null,l.jsxs(Uo,{children:[i,r?l.jsx(Zo,{children:r}):null]})]}),E=p.forwardRef(({hasClearButton:t=!0,startAdornment:o,endAdornment:e,isError:r,errorText:i,onChange:d,labelId:c,labelText:u,labelTestId:h,testID:k,...m},X)=>{const{disabled:U,readOnly:Z,value:q="",id:J}=m,y=p.useRef(null),j=t&&!(U||Z)&&!!q;p.useImperativeHandle(X,()=>y.current);const K=()=>{typeof d=="function"&&d(""),y.current&&y.current.focus()},Q=T=>{typeof d=="function"&&d(T.target.value,T)};return l.jsx(qo,{labelId:c,labelText:u,labelTestId:h,errorText:i,elementId:J,children:l.jsxs(Vo,{children:[o,l.jsx(Yo,{...m,$hasClearButton:j,$hasStartAdornment:!!o,$hasEndAdornment:!!e,ref:y,$error:r||!!i,onChange:Q,"data-testid":k}),j&&!e?l.jsx(Go,{testID:"input-clear-button",onClick:K}):null,e]})})});E.displayName="Input";var Jo=t=>{const o=parseFloat(t);return isNaN(o)?!1:Math.sign(o)<=0};a(({...t})=>l.jsx(E,{...t}))`
...
`,st=a.div`
  ${()=>{const{tokens:t}=s(),{inputLabelTop:o}=t;return n`
    ...
    `}}
`;function dt(t){const{htmlFor:o,label:e,labelHint:r,labelHintID:i,children:d,...c}=t,{tokens:u}=s(),{inputLabelTop:h}=u;return l.jsxs(it,{children:[l.jsxs("div",{children:[l.jsx("label",{...c,htmlFor:o,children:e&&l.jsx(at,{children:l.jsx(g,{component:"span",color:"inherit",fontFamily:h.label.fontFamily,variant:h.label.typographyVariant,children:e})})}),r&&l.jsx(st,{children:l.jsx(g,{id:i,component:"span",color:"inherit",fontFamily:h.labelHint.fontFamily,variant:h.labelHint.typographyVariant,children:r})})]}),l.jsx("div",{children:d})]})}var V=dt;a.div`
