import{j as i}from"./jsx-runtime-sfY7k0Xq.js";import{r as L}from"./index-CcKhGcwW.js";import{B as h}from"./index-CoGc3U6X.js";import{a as l,u as p,p as g,b as n}from"./index-5VPm3mt9.js";import{T as k}from"./Typography-Fd9Ks9lL.js";import{S as m}from"./Spinner-Dt7xEm7_.js";const v=l.div`
  display: flex;
  flex-direction: row;
  align-items: center;
...
`,C=l.div`
  ${({$variant:t,$isLoading:a})=>{const{tokens:r}=p(),{button:o}=r,{shadow:e}=o.bottomLayer;return[n`
      ...
      `,a&&n`
        ...
        `]}}
`,$=L.forwardRef((t,a)=>{const{variant:r,children:o,testID:e,type:d,isLoading:c,fullWidth:b,...u}=t;return i.jsxs(s,{...u,ref:a,$variant:r,$isLoading:c,$fullWidth:b,"data-testid":e,type:d||"button",children:[i.jsx(C,{$variant:r,$isLoading:c}),i.jsx(j,{$variant:r,$isLoading:c,children:o})]})});$.displayName="ButtonBase";const B=L.forwardRef((t,a)=>{const{text:r,variant:o=h.DEFAULT_VARIANT,startIcon:e,isLoading:d,testID:c="button",...b}=t,{tokens:u}=p(),{button:y}=u,f={"aria-disabled":d?!0:void 0,"aria-label":d?"Loading":void 0};return i.jsx($,{...f,...b,ref:a,variant:o,isLoading:d,testID:c,children:i.jsxs(v,{children:[e&&i.jsx(x,{$isLoading:d,children:e}),i.jsx(w,{$isLoading:d,children:i.jsx(k,{variant:y.topLayer.text.typography.variant,fontFamily:y.topLayer.text.typography.fontFamily,noWrap:!0,color:"inherit",component:"div",testID:`${c}-text`,children:r})}),d&&i.jsx(R,{children:i.jsx(m,{"aria-label":"Loading...",variant:h.SPINNER_VARIANTS[o],testID:`${c}-spinner`})})]})})});B.displayName="Button";export{B};
