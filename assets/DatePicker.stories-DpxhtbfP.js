import{j as a}from"./jsx-runtime-sfY7k0Xq.js";import{g as U,h as V,i as N,$ as Z,a as J,b as K,c as Q,d as X,e as Y,f as ee,j as ae}from"./Heading-CfYD3ecH.js";import{r as re}from"./index-CcKhGcwW.js";import{$ as te}from"./Button-DPtumZN7.js";import{$ as oe}from"./Group-oOA39aJ_.js";import{c as ne,a as le,b as ie}from"./Dialog-CLGWj2OB.js";import{a as p,u as n,b as f}from"./index-D1OOBdzz.js";import{a as de,A as ce,b as se}from"./index-Al28d7yc.js";import{f as ue}from"./index-C_4KMkng.js";import{R as pe}from"./ReactAriaProviders-CFG_2kIo.js";import{I as be,a as fe}from"./InputAlerts-BK_QjMFS.js";import{I as ge}from"./InputLabelTopV2-Cp-x5XMa.js";import{T as b}from"./Typography-DU98AY51.js";import{I as x}from"./IconButtonV2-0C_KITBC.js";import{u as he}from"./OverlayContext-DE6V0lcf.js";import{$ as $e}from"./useNumberFormatter-Be2B0OXy.js";const me=p.div`
...
`,Pe=p(N)`
  ${()=>{const{tokens:r}=n(),{datePicker:e}=r;return f`
    ...
    `}}
`;function ve(r,e){const{labelProps:l,alertProps:t,shouldForceLeadingZeros:g=!0,withCalendar:$,testID:m="date-picker",...G}=r,{tokens:O}=n(),{input:k}=O.datePicker,h=re.useMemo(()=>{if(t)return Array.isArray(t)?t:[t]},[t]);return a.jsx(pe,{externallyLabelledBy:r["aria-labelledby"],externallyDescribedBy:r["aria-describedby"],labelProps:l,alerts:h,children:({labelledBy:z,describedBy:q})=>a.jsx(me,{ref:e,"data-testid":m,children:a.jsx(be,{alert:h&&a.jsx(fe,{alerts:h}),children:a.jsx(ge,{...l,children:a.jsxs(Z,{...G,"aria-labelledby":z,"aria-describedby":q,shouldForceLeadingZeros:g,children:[a.jsxs(oe,{children:[a.jsx(ke,{children:M=>a.jsx(b,{component:"div",variant:k.segment.typography.variant,fontFamily:k.segment.typography.fontFamily,children:a.jsx(xe,{segment:M})})}),$&&a.jsx(te,{"data-testid":`${m}-calendar-button`,children:a.jsx(de,{})})]}),$&&a.jsx(L,{})]})})})})})}function L(){const{tokens:r}=n(),{calendar:e}=r.datePicker,{portalElement:l}=he();return a.jsx(le,{getContainer:l&&(()=>l),children:a.jsx(ie,{placement:"bottom right",children:a.jsx(ye,{children:a.jsxs(Pe,{children:[a.jsxs("header",{children:[a.jsx(x,{slot:"previous",children:a.jsx(ce,{})}),a.jsx(b,{component:J,variant:e.heading.typography.variant,fontFamily:e.heading.typography.fontFamily}),a.jsx(x,{slot:"next",children:a.jsx(se,{})})]}),a.jsxs(K,{children:[a.jsx(Q,{children:t=>a.jsx(X,{children:a.jsx(b,{variant:e.headerCell.typography.variant,fontFamily:e.headerCell.typography.fontFamily,children:t})})}),a.jsx(Y,{children:t=>a.jsx(ee,{date:t,children:({formattedDate:g})=>a.jsx(b,{color:"inherit",variant:e.cell.typography.variant,fontFamily:e.cell.typography.fontFamily,children:g})})})]})]})})})})}L.displayName="DatePickerCalendar";const we=ue(ve),je={title:"Components/Inputs/DatePicker",component:we,decorators:[r=>a.jsx($e,{locale:"en-IE",children:a.jsx(r,{})})]},o={args:{"aria-label":"DatePicker label"}},i={args:{labelProps:{label:"DatePicker label",labelTooltipProps:{iconButtonProps:{"aria-label":"Button label"},contentProps:{children:"APR stands for Annual Percentage Rate. It's the rate you will have to pay for the chosen loan amount."}}}}},d={args:{labelProps:{label:"DatePicker label",labelHint:"Additional information",labelHintTooltipProps:{iconButtonProps:{"aria-label":"Button label"},contentProps:{children:"APR stands for Annual Percentage Rate. It's the rate you will have to pay for the chosen loan amount."}}}}},c={args:{withCalendar:!0,labelProps:{label:"DatePicker label"}}},s={args:{withCalendar:!0,labelProps:{label:"DatePicker label"},isDateUnavailable:r=>ae(r,"en-IE")}},u={...o,args:{isInvalid:!0,withCalendar:!0,labelProps:{label:"DatePicker label"},alertProps:{severity:"error",children:"Error description over two lines if required."}}};var y,P,v;o.parameters={...o.parameters,docs:{...(y=o.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {
...
}`,...(R=(I=d.parameters)==null?void 0:I.docs)==null?void 0:R.source}}};var A,B,W;c.parameters={...c.parameters,docs:{...(A=c.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    withCalendar: true,
    labelProps: {
      label: "DatePicker label"
...
}`,...(W=(B=c.parameters)==null?void 0:B.docs)==null?void 0:W.source}}};var S,E,F;s.parameters={...s.parameters,docs:{...(S=s.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
    withCalendar: true,
    labelProps: {
      label: "DatePicker label"
...
}`,...(F=(E=s.parameters)==null?void 0:E.docs)==null?void 0:F.source}}};var T,_,H;u.parameters={...u.parameters,docs:{...(T=u.parameters)==null?void 0:T.docs,source:{originalSource:`{
  ...Basic,
  args: {
    isInvalid: true,
    withCalendar: true,
...
}`,...(H=(_=u.parameters)==null?void 0:_.docs)==null?void 0:H.source}}};const Ce=["Basic","WithLabel","WithHint","WithCalendar","WithDisabledDates","Invalid"],qe=Object.freeze(Object.defineProperty({__proto__:null,Basic:o,Invalid:u,WithCalendar:c,WithDisabledDates:s,WithHint:d,WithLabel:i,__namedExportsOrder:Ce,default:je},Symbol.toStringTag,{value:"Module"}));export{o as B,qe as D,u as I,i as W,d as a,c as b,s as c};
