import{r as p}from"./index-c013ead5.js";import{a as i,u as s,p as b,b as n,j as l,h as q}from"./index-74fe31d7.js";import{T as B}from"./index-f9a152de.js";import{C as J,a as K,M as Q,T as D,b as oo}from"./index-40416c04.js";import{u as R,F as to,a as eo}from"./floating-ui.react-06582175.js";import{i as ro}from"./react-textarea-autosize.browser.esm-05f9ff93.js";var no=i.div`
  display: flex;
  flex-direction: row;
  align-items: center;
...
`,so=i.div`
  ${({$variant:t})=>{const{tokens:o}=s(),{button:e}=o,{shadow:r}=e.bottomLayer;return n`
    ...
    `}}
`,lo=p.forwardRef((t,o)=>{const{variant:e,children:r,testID:a,type:d,fullWidth:c,...u}=t;return l.jsxs(v,{...u,ref:o,$variant:e,$fullWidth:c,"data-testid":a,type:d||"button",children:[l.jsx(so,{$variant:e}),l.jsx(ao,{$variant:e,children:r})]})}),co=lo,uo=i.p`
  ${({$variant:t,$fontFamily:o,$noWrap:e,$color:r})=>{const{tokens:a}=s(),{typography:d,fontFamily:c}=a,u=b(d.fontSize[t]),h=b(d.lineHeight[t]);return[n`
      ...
      `,o&&n`
        ...
        `]}}
`;function ho(t,o){const{variant:e,component:r,color:a,fontFamily:d,noWrap:c,testID:u,...h}=t;return l.jsx(uo,{...h,ref:o,as:r,$variant:e,$color:a,$fontFamily:d,$noWrap:c,"data-testid":u})}var po=p.forwardRef(ho),bo={displayXL:"h1",displayL:"h1",displayM:"h1",displayS:"h1",headlineL:"h1",headlineM:"h2",headlineS:"h3",headlineXS:"h4",titleL:"h2",titleM:"h3",titleS:"h4",titleXS:"h5",bodyL:"p",bodyM:"p",bodyS:"p",labelM:"p",labelS:"p"},go=p.forwardRef;function $o(t,o){const{variant:e="bodyM",component:r,...a}=t;return l.jsx(po,{...a,ref:o,variant:e,component:r||bo[e]})}var g=go($o);p.forwardRef((t,o)=>{const{text:e,variant:r="primary",startIcon:a,testID:d="button",...c}=t,{tokens:u}=s(),{button:h}=u;return l.jsx(co,{...c,ref:o,variant:r,testID:d,children:l.jsxs(no,{children:[a&&l.jsx(io,{children:a}),l.jsx(g,{fontFamily:h.topLayer.text.fontFamily,variant:h.topLayer.text.typographyVariant,noWrap:!0,color:"inherit",testID:`${d}-text`,children:e})]})})});var fo=i.div`
  ${({$gap:t="8px"})=>`
    display: grid;
    justify-items: start;
    gap: ${t};
  `}
`;function ko(t){const{alert:o,gap:e,children:r}=t;return l.jsxs(fo,{$gap:e,children:[r,o&&o]})}var O=ko,vo=i.div`
...
`,mo=i.div`
  ${()=>{const{tokens:t}=s(),{inputAlert:o}=t,e=b(o.iconWrapper.height);return n`
      ...
      height: ${e};
    `}}
`;function wo(t){const{severity:o,children:e,testID:r="input-alert"}=t;return l.jsxs(vo,{role:"alert","aria-live":"polite",$severity:o,"data-testid":r,children:[l.jsx(mo,{children:l.jsx(K,{"aria-hidden":"true"})}),l.jsx(g,{color:"inherit",children:e})]})}var S=wo,yo=i.label`
...
`,xo=i.span`
  ${()=>{const{tokens:t}=s(),{inputLabelRight:o}=t;return n`
    ...
    `}}
`;function Co(t){const{label:o,children:e,...r}=t,{tokens:a}=s(),{inputLabelRight:d}=a;return l.jsxs(yo,{...r,children:[l.jsx("span",{children:e}),o&&l.jsx(xo,{children:l.jsx(g,{component:"span",color:"inherit",fontFamily:d.label.fontFamily,variant:d.label.typographyVariant,children:o})})]})}var P=Co,I=i.div`
...
`,Lo=i(D)`
  ${()=>{const{tokens:t}=s(),{checkbox:o}=t;return[n`
      ...
      `]}}
`;function jo(t,o){p.useEffect(()=>{t.current&&(t.current.indeterminate=!!o)},[o])}var To=p.forwardRef((t,o)=>{const{hasError:e,isIndeterminate:r,testID:a="checkbox",...d}=t,c=p.useRef(null);jo(c,r);const u=R([c,o]);function h(m){var k;m.target.indeterminate=!!r,(k=d.onChange)==null||k.call(d,m)}return l.jsxs(I,{$hasError:e,children:[l.jsx(Ro,{...d,ref:u,type:"checkbox",onChange:h,"data-testid":a}),l.jsx(Io,{}),l.jsx(Lo,{})]})}),Bo=To;p.forwardRef((t,o)=>{const{labelProps:e,alertProps:r,...a}=t,{testID:d="checkbox"}=a;return l.jsx(O,{alert:r?l.jsx(S,{...r,testID:`${d}-alert`}):void 0,children:l.jsx(P,{...e,children:l.jsx(Bo,{...a,ref:o})})})});i.fieldset`
...
`;var z="1px";i.div`
  ${({position:t})=>{const{tokens:o}=s(),{adornment:e,input:r}=o;return[n`
        ...
        `};
      `]}}
`;var W=t=>({id:t.id,className:t.className,"data-testid":t.testID}),Fo=i.div`
  position: relative;
  display: flex;
  align-items: center;
  width: 100%;
...
`,Oo=i.div`
  ${()=>{const{tokens:t}=s(),{clearButton:o}=t;return n`
    ...
    `}}
`,So=({onClick:t,...o})=>{const{tokens:e}=s(),{clearButton:r}=e;return l.jsx(Oo,{...W(o),role:"button",onClick:t,children:l.jsx(J,{width:16,height:16,color:r.color.base})})},Po=i.div`
  display: flex;
...
`,Ao=i.div`
  ${()=>{const{tokens:t}=s(),{fontFamily:o,themeColor:e}=t;return[n`
        ...
        width: 100%;
      `]}}
`,_o=({elementId:t,labelId:o,labelText:e,errorText:r,children:a,labelTestId:d,...c})=>l.jsxs(Po,{...W(c),children:[e?l.jsx(g,{id:o,component:"label",htmlFor:t,testID:d,children:e}):null,l.jsxs(Wo,{children:[a,r?l.jsx(Ao,{children:r}):null]})]}),A=p.forwardRef(({hasClearButton:t=!0,startAdornment:o,endAdornment:e,isError:r,errorText:a,onChange:d,labelId:c,labelText:u,labelTestId:h,testID:m,...k},V)=>{const{disabled:M,readOnly:Y,value:G="",id:X}=k,w=p.useRef(null),j=t&&!(M||Y)&&!!G;p.useImperativeHandle(V,()=>w.current);const U=()=>{typeof d=="function"&&d(""),w.current&&w.current.focus()},Z=T=>{typeof d=="function"&&d(T.target.value,T)};return l.jsx(_o,{labelId:c,labelText:u,labelTestId:h,errorText:a,elementId:X,children:l.jsxs(Fo,{children:[o,l.jsx(Do,{...k,$hasClearButton:j,$hasStartAdornment:!!o,$hasEndAdornment:!!e,ref:w,$error:r||!!a,onChange:Z,"data-testid":m}),j&&!e?l.jsx(So,{testID:"input-clear-button",onClick:U}):null,e]})})});A.displayName="Input";var Eo=t=>{const o=parseFloat(t);return isNaN(o)?!1:Math.sign(o)<=0};i(({...t})=>l.jsx(A,{...t}))`
  ...
  // in the styleguide
  & input {
    color: ${({value:t})=>Eo(t)?"#b20000":void 0};
  }
`;i.div`
...
`,No=i.a`
  ${({$display:t})=>{const{tokens:o}=s(),{link:e}=o;return n`
    ...
    `}}
`,Vo=p.forwardRef;function Mo(t,o){const{display:e="inline",component:r="a",testID:a="link",...d}=t;return l.jsx(No,{...d,ref:o,as:r,"data-testid":a,$display:e})}var _=Vo(Mo),Yo=p.forwardRef((t,o)=>{const{children:e,...r}=t,{tokens:a}=s(),{link:d}=a;return l.jsx(_,{...r,ref:o,children:l.jsx(Ho,{component:"span",color:"inherit",variant:d.typographyVariant,fontFamily:d.fontFamily,children:e})})});Yo.displayName="Link";var C=i.div`
  ${()=>{const{tokens:t}=s(),{link:o}=t;return[n`
        display: inline-flex;
        gap: ${o.withIcon.gap};
      `]}}
...
`,F=i.div`
  ${()=>{const{tokens:t}=s(),{link:o}=t,e=b(o.withIcon.size);return n`
    ...
    `}}
`,Xo=p.forwardRef((t,o)=>{const{children:e,startIcon:r,endIcon:a,testID:d="link",...c}=t,{tokens:u}=s(),{link:h}=u;return l.jsx(_,{...c,ref:o,display:"inline-flex",testID:d,children:l.jsxs(C,{children:[r&&l.jsx(F,{"data-testid":`${d}-start-icon-wrapper`,children:r}),l.jsx(Go,{component:"span",color:"inherit",variant:h.typographyVariant,fontFamily:h.fontFamily,children:e}),a&&l.jsx(F,{"data-testid":`${d}-end-icon-wrapper`,children:a})]})})});Xo.displayName="LinkWithIcon";i.div`
  overflow: hidden;
`;i.div`
...
`,qo=i.div`
  ${()=>{const{tokens:t}=s(),{inputLabelTop:o}=t;return n`
    ...
    `}}
`;function Jo(t){const{htmlFor:o,label:e,labelHint:r,labelHintID:a,children:d,...c}=t,{tokens:u}=s(),{inputLabelTop:h}=u;return l.jsxs(Uo,{children:[l.jsxs("div",{children:[l.jsx("label",{...c,htmlFor:o,children:e&&l.jsx(Zo,{children:l.jsx(g,{component:"span",color:"inherit",fontFamily:h.label.fontFamily,variant:h.label.typographyVariant,children:e})})}),r&&l.jsx(qo,{children:l.jsx(g,{id:a,component:"span",color:"inherit",fontFamily:h.labelHint.fontFamily,variant:h.labelHint.typographyVariant,children:r})})]}),l.jsx("div",{children:d})]})}var E=Jo;i.div`
...
`,ot=i.div`
  ${()=>{const{tokens:t}=s(),{radio:o}=t;return[n`
      ...
      `]}}
`,tt=p.forwardRef((t,o)=>{const{hasError:e,testID:r="radio",...a}=t;return l.jsxs(y,{$hasError:e,children:[l.jsx(Qo,{...a,ref:o,type:"radio","data-testid":r}),l.jsx(ot,{})]})}),et=tt;p.forwardRef((t,o)=>{const{labelProps:e,alertProps:r,...a}=t,{testID:d="radio"}=a;return l.jsx(O,{alert:r?l.jsx(S,{...r,testID:`${d}-alert`}):void 0,children:l.jsx(P,{...e,children:l.jsx(et,{...a,ref:o})})})});i.div`
...
`,x=i.div`
  ...
  ${({$index:t,$borderWidth:o})=>n`
    ...
    `}
`,at=p.memo(t=>{const{testID:o="spinner"}=t,{tokens:{spinner:e}}=s();let r,a;if("variant"in t){const u=e.variants[t.variant];u&&([r,a]=[u.color,u.size])}"size"in t&&t.size?a=t.size:a||(a=e.variants.default.size),"color"in t&&t.color?r=t.color:r||(r=e.variants.default.color);const c={$borderWidth:Math.round(a/Number(e.borderRatio))};return l.jsxs(nt,{$color:r,$size:a,"data-testid":o,children:[l.jsx(it,{...c}),l.jsx(x,{$index:0,...c}),l.jsx(x,{$index:1,...c}),l.jsx(x,{$index:2,...c})]})});at.displayName="Spinner";i.div`
  margin-bottom: 1rem;
`;i.div`
  width: ${t=>t.width||"100%"};
...
`;var dt=i(g)`
  ${()=>{const{tokens:t}=s(),{charactersCounter:o}=t;return n`
    ...
    `}}
`;function lt(t){const{length:o,maxLength:e,testID:r}=t,{tokens:a}=s(),{charactersCounter:d}=a,c=Math.max(0,e-o);return l.jsx(dt,{variant:d.typographyVariant,testID:r,"aria-live":"polite",children:`${c} character${c!==1?"s":""} remaining`})}p.memo(lt);var ct=i(E)`
  ${()=>n`
      width: 100%;
    `}
`;i.div`
...
`;i.div`
  ${({$toggleSize:t})=>{const{tokens:{toggle:o}}=s(),e=b(o.size[t].width);return n`
    ...
    `}}
`;var ut=p.createContext(null),N=()=>{const t=p.useContext(ut);if(!t)throw new Error("Tooltip components must be wrapped in <Tooltip />");return t},ht=i.div`
  ${()=>{const{tokens:t}=s(),{tooltip:o}=t;return n`
      ...
      z-index: ${o.zIndex};
    `}}
`;p.forwardRef((t,o)=>{const{children:e,...r}=t,{tokens:a}=s(),{tooltip:d}=a,{open:c,arrowRef:u,floatingData:h,interactionsData:m}=N(),k=R([h.refs.setFloating,o]);return c?l.jsx(to,{children:l.jsxs(ht,{ref:k,style:h.floatingStyles,...m.getFloatingProps(r),children:[l.jsx(eo,{ref:u,context:h.context,fill:d.backgroundColor,width:parseInt(d.arrow.width),height:parseInt(d.arrow.height)}),e]})}):null});p.forwardRef((t,o)=>{const{children:e,...r}=t,{open:a,floatingData:d,interactionsData:c}=N(),u=e.ref,h=R([d.refs.setReference,u,o]);return p.isValidElement(e)?p.cloneElement(e,c.getReferenceProps({ref:h,...r,...e.props,"data-state":a?"open":"closed"})):null});export{g as T};
