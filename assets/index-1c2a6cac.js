...
`,Ro=a.div`
  ${({$variant:t,$isLoading:o})=>{const{tokens:e}=s(),{button:r}=e,{shadow:i}=r.bottomLayer;return[n`
      ...
      `,o&&n`
        ...
        `]}}
`,P=u.forwardRef((t,o)=>{const{variant:e,children:r,testID:i,type:d,isLoading:c,fullWidth:h,...p}=t;return l.jsxs(b,{...p,ref:o,$variant:e,$isLoading:c,$fullWidth:h,"data-testid":i,type:d||"button",children:[l.jsx(Ro,{$variant:e,$isLoading:c}),l.jsx(Co,{$variant:e,$isLoading:c,children:r})]})});P.displayName="ButtonBase";var Lo=P,Io=ro`
  0% {
...
`,Zo=a.div`
  ${()=>{const{tokens:t}=s(),{clearButton:o}=t;return n`
    ...
    `}}
`,qo=({onClick:t,...o})=>{const{tokens:e}=s(),{clearButton:r}=e;return l.jsx(Zo,{...H(o),role:"button",onClick:t,children:l.jsx(no,{width:16,height:16,color:r.color.base})})},Jo=a.div`
  display: flex;
