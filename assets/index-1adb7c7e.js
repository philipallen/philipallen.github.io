import{r as u}from"./index-c013ead5.js";import{T as z,B as ro}from"./index-f15beae1.js";import{a,u as s,b as n,p as g,h as no}from"./index-912b60f4.js";import{C as io,E as ao,M as so,T as O,a as lo}from"./index-5cf7436a.js";import{j as l}from"./jsx-runtime-6eef64cc.js";import{u as L,F as co,a as uo}from"./floating-ui.react-06582175.js";import{i as ho}from"./react-textarea-autosize.browser.esm-05f9ff93.js";a.div`
...
`;a.div`
  ${({hidden:t})=>{const{tokens:o}=s(),{accordion:e}=o;return[n`
      ...
      `]}}
`;var po=a.p`
  ${({$variant:t,$fontFamily:o,$noWrap:e,$color:r})=>{const{tokens:i}=s(),{typography:d,fontFamily:c}=i,h=g(d.fontSize[t]),p=g(d.lineHeight[t]);return[n`
        margin: 0;
        font-weight: normal;
        color: ${r||d.color[t]};
        font-size: ${h};
      ...
      `,o&&n`
        ...
        `,z.STANDARD_VARIANTS.includes(t)&&n`
          & strong,
          & b {
          ...
          & em,
          & i {
            font-family: ${z.BOLD_FONT_FAMILIES.includes(o)?c.OpenSansSemiBoldItalic:c.OpenSansItalic};
        ...
        `]}}
`;function bo(t,o){const{variant:e,component:r,color:i,fontFamily:d,noWrap:c,testID:h,...p}=t;return l.jsx(po,{...p,ref:o,as:r,$variant:e,$color:i,$fontFamily:d,$noWrap:c,"data-testid":h})}var go=u.forwardRef(bo),$o={displayXL:"h1",displayL:"h1",displayM:"h1",displayS:"h1",headlineL:"h1",headlineM:"h2",headlineS:"h3",headlineXS:"h4",titleL:"h2",titleM:"h3",titleS:"h4",titleXS:"h5",bodyL:"p",bodyM:"p",bodyS:"p",labelM:"p",labelS:"p"},fo=u.forwardRef;function ko(t,o){const{variant:e="bodyM",component:r,...i}=t;return l.jsx(go,{...i,ref:o,variant:e,component:r||$o[e]})}var $=fo(ko),vo=a.div`
...
`,Ro=a.div`
  ${({$variant:t,$isLoading:o})=>{const{tokens:e}=s(),{button:r}=e,{shadow:i}=r.bottomLayer;return[n`
      ...
      `,o&&n`
        ...
        `]}}
`,P=u.forwardRef((t,o)=>{const{variant:e,children:r,testID:i,type:d,isLoading:c,fullWidth:h,...p}=t;return l.jsxs(b,{...p,ref:o,$variant:e,$isLoading:c,$fullWidth:h,"data-testid":i,type:d||"button",children:[l.jsx(Ro,{$variant:e,$isLoading:c}),l.jsx(Co,{$variant:e,$isLoading:c,children:r})]})});P.displayName="ButtonBase";var Lo=P,Io=no`
  0% {
...
`,C=a.div`
  ...
  ${({$index:t,$borderWidth:o})=>n`
    ...
    `}
`,W=u.memo(t=>{const{testID:o="spinner"}=t,{tokens:{spinner:e}}=s();let r,i;if("variant"in t){const h=e.variants[t.variant];h&&([r,i]=[h.color,h.size])}"size"in t&&t.size?i=t.size:i||(i=e.variants.default.size),"color"in t&&t.color?r=t.color:r||(r=e.variants.default.color);const c={$borderWidth:`${Math.round(parseInt(i)/parseInt(e.borderRatio))}px`};return l.jsxs(jo,{$color:r,$size:i,"data-testid":o,children:[l.jsx(To,{...c}),l.jsx(C,{$index:0,...c}),l.jsx(C,{$index:1,...c}),l.jsx(C,{$index:2,...c})]})});W.displayName="Spinner";var Bo=W,zo=u.forwardRef((t,o)=>{const{text:e,variant:r="primary",startIcon:i,isLoading:d,testID:c="button",...h}=t,{tokens:p}=s(),{button:k}=p,v={"aria-disabled":d,"aria-label":d?"Loading":void 0};return l.jsx(Lo,{...h,...v,ref:o,variant:r,isLoading:d,testID:c,children:l.jsxs(mo,{children:[i&&l.jsx(yo,{$isLoading:d,children:i}),l.jsx(wo,{$isLoading:d,children:l.jsx($,{fontFamily:k.topLayer.text.fontFamily,variant:k.topLayer.text.typographyVariant,noWrap:!0,color:"inherit",testID:`${c}-text`,children:e})}),d&&l.jsx(xo,{children:l.jsx(Bo,{variant:ro.SPINNER_VARIANTS[r],testID:`${c}-spinner`})})]})})});zo.displayName="Button";var So=a.div`
  ${({$gap:t="8px"})=>`
    display: grid;
    justify-items: start;
    gap: ${t};
  `}
`;function Do(t){const{alert:o,gap:e,children:r}=t;return l.jsxs(So,{$gap:e,children:[r,o&&o]})}var N=Do,Fo=a.div`
...
`,Oo=a.div`
  ${()=>{const{tokens:t}=s(),{inputAlert:o}=t,e=g(o.iconWrapper.height);return n`
      ...
      height: ${e};
    `}}
`;function Po(t){const{severity:o,children:e,testID:r="input-alert"}=t,{tokens:i}=s(),{inputAlert:d}=i;return l.jsxs(Fo,{role:"alert","aria-live":"polite",$severity:o,"data-testid":r,children:[l.jsx(Oo,{children:l.jsx(ao,{primaryColor:d.icon.primaryColor[o],secondaryColor:d.icon.secondaryColor[o],"aria-hidden":"true"})}),l.jsx($,{color:"inherit",children:e})]})}var _=Po,Wo=a.label`
...
`,No=a.span`
  ${()=>{const{tokens:t}=s(),{inputLabelRight:o}=t;return n`
    ...
    `}}
`;function _o(t){const{label:o,children:e,...r}=t,{tokens:i}=s(),{inputLabelRight:d}=i;return l.jsxs(Wo,{...r,children:[l.jsx("span",{children:e}),o&&l.jsx(No,{children:l.jsx($,{component:"span",color:"inherit",fontFamily:d.label.fontFamily,variant:d.label.typographyVariant,children:o})})]})}var A=_o,I=a.div`
...
`,Ho=a(O)`
  ${()=>{const{tokens:t}=s(),{checkbox:o}=t;return[n`
      ...
      `]}}
`;function Vo(t,o){u.useEffect(()=>{t.current&&(t.current.indeterminate=!!o)},[o])}var E=u.forwardRef((t,o)=>{const{hasError:e,isIndeterminate:r,testID:i="checkbox",...d}=t,c=u.useRef(null);Vo(c,r);const h=L([c,o]);function p(k){var v;k.target.indeterminate=!!r,(v=d.onChange)==null||v.call(d,k)}return l.jsxs(I,{$hasError:e,children:[l.jsx(Ao,{...d,ref:h,type:"checkbox",onChange:p,"data-testid":i}),l.jsx(Eo,{}),l.jsx(Ho,{})]})});E.displayName="CheckboxBase";var Yo=E,Mo=u.forwardRef((t,o)=>{const{labelProps:e,alertProps:r,...i}=t,{testID:d="checkbox"}=i;return l.jsx(N,{alert:r?l.jsx(_,{...r,testID:`${d}-alert`}):void 0,children:l.jsx(A,{...e,children:l.jsx(Yo,{...i,ref:o})})})});Mo.displayName="Checkbox";a.fieldset`
...
`;var S="1px";a.div`
  ${({position:t})=>{const{tokens:o}=s(),{adornment:e,input:r}=o;return[n`
        ...
        `};
      `]}}
`;var H=t=>({id:t.id,className:t.className,"data-testid":t.testID}),Xo=a.div`
  position: relative;
  display: flex;
  align-items: center;
  width: 100%;
`,Uo=a.input`
  ${({$error:t,$hasStartAdornment:o,$hasEndAdornment:e,$hasClearButton:r})=>{const{tokens:i}=s(),{input:d,adornment:c,clearButton:h}=i;return[n`
        height: ${d.height};
        width: 100%;
        ...
        padding-right: ${e?`calc(${c.width.small} + ${d.paddingRight})`:r?h.width:d.paddingRight};
        outline: none;
...
`,Zo=a.div`
  ${()=>{const{tokens:t}=s(),{clearButton:o}=t;return n`
    ...
    `}}
`,qo=({onClick:t,...o})=>{const{tokens:e}=s(),{clearButton:r}=e;return l.jsx(Zo,{...H(o),role:"button",onClick:t,children:l.jsx(io,{width:16,height:16,color:r.color.base})})},Jo=a.div`
  display: flex;
...
`,Qo=a.div`
  ${()=>{const{tokens:t}=s(),{fontFamily:o,themeColor:e}=t;return[n`
        ...
        width: 100%;
      `]}}
`,ot=({elementId:t,labelId:o,labelText:e,errorText:r,children:i,labelTestId:d,...c})=>l.jsxs(Jo,{...H(c),children:[e?l.jsx($,{id:o,component:"label",htmlFor:t,testID:d,children:e}):null,l.jsxs(Ko,{children:[i,r?l.jsx(Qo,{children:r}):null]})]}),V=u.forwardRef(({hasClearButton:t=!0,startAdornment:o,endAdornment:e,isError:r,errorText:i,onChange:d,labelId:c,labelText:h,labelTestId:p,testID:k,...v},q)=>{const{disabled:J,readOnly:K,value:Q="",id:oo}=v,y=u.useRef(null),T=t&&!(J||K)&&!!Q;u.useImperativeHandle(q,()=>y.current);const to=()=>{typeof d=="function"&&d(""),y.current&&y.current.focus()},eo=B=>{typeof d=="function"&&d(B.target.value,B)};return l.jsx(ot,{labelId:c,labelText:h,labelTestId:p,errorText:i,elementId:oo,children:l.jsxs(Xo,{children:[o,l.jsx(Uo,{...v,$hasClearButton:T,$hasStartAdornment:!!o,$hasEndAdornment:!!e,ref:y,$error:r||!!i,onChange:eo,"data-testid":k}),T&&!e?l.jsx(qo,{testID:"input-clear-button",onClick:to}):null,e]})})});V.displayName="Input";var tt=t=>{const o=parseFloat(t);return isNaN(o)?!1:Math.sign(o)<=0};a(({...t})=>l.jsx(V,{...t}))`
  ...
  // in the styleguide
  & input {
    color: ${({value:t})=>tt(t)?"#b20000":void 0};
  }
`;a.div`
...
`,nt=a.div`
  ${()=>{const{tokens:t}=s(),{inputLabelTop:o}=t;return n`
    ...
    `}}
`;function Y(t){const{label:o,labelHint:e,labelHintID:r,children:i}=t,{tokens:d}=s(),{inputLabelTop:c}=d;return l.jsxs(et,{children:[l.jsxs("div",{children:[o,e&&l.jsx(nt,{children:l.jsx($,{id:r,component:"span",color:"inherit",fontFamily:c.labelHint.fontFamily,variant:c.labelHint.typographyVariant,children:e})})]}),l.jsx("div",{children:i})]})}Y.Label=t=>{const{text:o,component:e="span"}=t,{tokens:r}=s(),{inputLabelTop:i}=r;return l.jsx(rt,{children:l.jsx($,{component:e,color:"inherit",fontFamily:i.label.fontFamily,variant:i.label.typographyVariant,children:o})})};var D=Y,it=a($)`
...
`,at=a.a`
  ${({$display:t})=>{const{tokens:o}=s(),{link:e}=o;return n`
    ...
    `}}
`,st=u.forwardRef;function dt(t,o){const{display:e="inline",component:r="a",testID:i="link",...d}=t;return l.jsx(at,{...d,ref:o,as:r,"data-testid":i,$display:e})}var M=st(dt),lt=u.forwardRef((t,o)=>{const{children:e,...r}=t,{tokens:i}=s(),{link:d}=i;return l.jsx(M,{...r,ref:o,children:l.jsx(it,{component:"span",color:"inherit",variant:d.typographyVariant,fontFamily:d.fontFamily,children:e})})});lt.displayName="Link";var R=a.div`
  ${()=>{const{tokens:t}=s(),{link:o}=t;return[n`
        display: inline-flex;
        gap: ${o.withIcon.gap};
      `]}}
...
`,F=a.div`
  ${()=>{const{tokens:t}=s(),{link:o}=t,e=g(o.withIcon.size);return n`
    ...
    `}}
`,ut=u.forwardRef((t,o)=>{const{children:e,startIcon:r,endIcon:i,testID:d="link",...c}=t,{tokens:h}=s(),{link:p}=h;return l.jsx(M,{...c,ref:o,display:"inline-flex",testID:d,children:l.jsxs(R,{children:[r&&l.jsx(F,{"data-testid":`${d}-start-icon-wrapper`,children:r}),l.jsx(ct,{component:"span",color:"inherit",variant:p.typographyVariant,fontFamily:p.fontFamily,children:e}),i&&l.jsx(F,{"data-testid":`${d}-end-icon-wrapper`,children:i})]})})});ut.displayName="LinkWithIcon";a.div`
  overflow: hidden;
`;a.div`
...
`;a.div`
  ${({$isSelected:t,$isHighlighted:o})=>{const{tokens:e}=s(),{multiSelect:r}=e;return[n`
      ...
      `,t&&n`
        ...
        `]}}
`;function ht(t){const{htmlFor:o,label:e,labelHint:r,labelHintID:i,children:d,...c}=t;return l.jsx(D,{label:l.jsx("label",{...c,htmlFor:o,children:e&&l.jsx(D.Label,{text:e})}),labelHint:r,labelHintID:i,children:d})}var G=ht;a.div`
...
`,gt=a.div`
  ${()=>{const{tokens:t}=s(),{radio:o}=t;return[n`
      ...
      `]}}
`,U=u.forwardRef((t,o)=>{const{hasError:e,testID:r="radio",...i}=t;return l.jsxs(w,{$hasError:e,children:[l.jsx(bt,{...i,ref:o,type:"radio","data-testid":r}),l.jsx(gt,{})]})});U.displayName="RadioBase";var $t=U,ft=u.forwardRef((t,o)=>{const{labelProps:e,alertProps:r,...i}=t,{testID:d="radio"}=i;return l.jsx(N,{alert:r?l.jsx(_,{...r,testID:`${d}-alert`}):void 0,children:l.jsx(A,{...e,children:l.jsx($t,{...i,ref:o})})})});ft.displayName="Radio";a.div`
...
`;var vt=a($)`
  ${()=>{const{tokens:t}=s(),{charactersCounter:o}=t;return n`
    ...
    `}}
`;function mt(t){const{length:o,maxLength:e,testID:r}=t,{tokens:i}=s(),{charactersCounter:d}=i,c=Math.max(0,e-o);return l.jsx(vt,{variant:d.typographyVariant,testID:r,"aria-live":"polite",children:`${c} character${c!==1?"s":""} remaining`})}u.memo(mt);var yt=a(G)`
  ${()=>n`
      width: 100%;
    `}
`;a.div`
...
`;a.div`
  ${({$toggleSize:t})=>{const{tokens:{toggle:o}}=s(),e=g(o.size[t].width);return n`
    ...
    `}}
`;var wt=u.createContext(null),Z=()=>{const t=u.useContext(wt);if(!t)throw new Error("Tooltip components must be wrapped in <Tooltip />");return t},xt=a.div`
  ${()=>{const{tokens:t}=s(),{tooltip:o}=t;return n`
      ...
      z-index: ${o.zIndex};
    `}}
`,Ct=u.forwardRef((t,o)=>{const{children:e,...r}=t,{tokens:i}=s(),{tooltip:d}=i,{open:c,arrowRef:h,floatingData:p,interactionsData:k}=Z(),v=L([p.refs.setFloating,o]);return c?l.jsx(co,{children:l.jsxs(xt,{ref:v,style:p.floatingStyles,...k.getFloatingProps(r),children:[l.jsx(uo,{ref:h,context:p.context,fill:d.backgroundColor,width:parseInt(d.arrow.width),height:parseInt(d.arrow.height)}),e]})}):null});Ct.displayName="TooltipContent";var Rt=u.forwardRef((t,o)=>{const{children:e,...r}=t,{open:i,floatingData:d,interactionsData:c}=Z(),h=e.ref,p=L([d.refs.setReference,h,o]);return u.isValidElement(e)?u.cloneElement(e,c.getReferenceProps({ref:p,...r,...e.props,"data-state":i?"open":"closed"})):null});Rt.displayName="TooltipTrigger";export{$ as T};
