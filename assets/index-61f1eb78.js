...
`,Oo=a.div`
  ${({$severity:t})=>{const{tokens:o}=s(),{inputAlert:e}=o,r=g(e.iconWrapper.height);return n`
    ...
    `}}
`;function Po(t){const{severity:o,children:e,testID:r="input-alert"}=t;return l.jsxs(Fo,{role:"alert","aria-live":"polite",$severity:o,"data-testid":r,children:[l.jsx(Oo,{$severity:o,children:l.jsx(ao,{"aria-hidden":"true"})}),l.jsx($,{color:"inherit",children:e})]})}var _=Po,Wo=a.label`
