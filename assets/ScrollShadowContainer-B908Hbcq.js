import{j as d}from"./jsx-runtime-sfY7k0Xq.js";import{r as s}from"./index-CcKhGcwW.js";import{c as S}from"./FocusScope-Ck7OBOj_.js";import{O as k}from"./OverlayContext-DE6V0lcf.js";import{a as h,u as f,b as c}from"./index-5VPm3mt9.js";import{n as E}from"./utils-2-3EihAd.js";import{a as j}from"./usePreventScroll-H9RN8w3y.js";let r=typeof document<"u"&&window.visualViewport;function y(){let o=E(),[e,t]=s.useState(()=>o?{width:0,height:0}:$());return s.useEffect(()=>{let i=()=>{t(n=>{let a=$();return a.width===n.width&&a.height===n.height?n:a})};return r?r.addEventListener("resize",i):window.addEventListener("resize",i),()=>{r?r.removeEventListener("resize",i):window.removeEventListener("resize",i)}},[]),e}function $(){return{width:r&&(r==null?void 0:r.width)||window.innerWidth,height:r&&(r==null?void 0:r.height)||window.innerHeight}}const R=h.dialog`
