import{j as i}from"./jsx-runtime-sfY7k0Xq.js";import{i as g}from"./index-ChacPRz0.js";import{a as c,u as p,b as d}from"./index-Dwsyfx_g.js";import{E,W as B,g as F,h as L}from"./index-BKbNTvCu.js";import{C as T,M as I,S as _}from"./ScrollShadowContainer-CTGN500Y.js";import{r as f}from"./index-CcKhGcwW.js";import{T as A}from"./Typography-Ck2BLUk-.js";import{B as S}from"./Button-BIN63KTR.js";const P=c(T)`
  display: grid;
...
`,U=c.div`
  ${({$layout:e,$stickFooter:a})=>{const{tokens:o}=p(),{alertModal:t,modal:n}=o;return[d`
      ...
      `,a&&d`
        ...
        `]}}
`;function u(){const{tokens:e}=p(),{modal:a}=e,o=window.matchMedia(`(min-width: ${a.breakpoints.tablet})`),[t,n]=f.useState(()=>o.matches);return f.useEffect(()=>{function l(r){n(r.matches)}return o.addEventListener("change",l),()=>{o.removeEventListener("change",l)}},[]),{isMobile:!t}}function R(e,a,o){const{isMobile:t}=u(),n=(a||[]).map(s=>({...s,variant:"primary"})),l=(o||[]).map(s=>({...s,variant:"secondary"})),r=[];return t||e==="stacked"?r.push(...n.reverse(),...l.reverse()):r.push(...l,...n),{orderedButtonsProps:r}}function W(e){const{heading:a,headingLevel:o=g.DEFAULT_HEADING_LEVEL,severity:t=g.DEFAULT_SEVERITY,primaryButtonsProps:n,secondaryButtonsProps:l,footerLayout:r=g.DEFAULT_FOOTER_LAYOUT,hasStickyFooter:s=!1,children:y,testID:k="alert-modal",...m}=e,{isOpen:v}=m,{tokens:w}=p(),{alertModal:h}=w,M={error:i.jsx(E,{}),warning:i.jsx(B,{}),success:i.jsx(F,{}),info:i.jsx(L,{})},{isMobile:x}=u(),{orderedButtonsProps:j}=R(r,n,l),b=i.jsx("div",{children:i.jsx(U,{$layout:x?"stacked":r,$stickFooter:s,children:j.map($=>i.jsx(S,{...$},$.children))})});return i.jsx(I,{"aria-label":a,testID:k,...m,children:v&&i.jsxs(P,{children:[i.jsxs(C,{$severity:t,children:[i.jsx(D,{$severity:t,children:M[t]}),i.jsx(A,{component:`h${o}`,variant:h.heading.typography.variant,fontFamily:h.heading.typography.fontFamily,children:a})]}),i.jsxs(_,{children:[i.jsx(O,{$stickFooter:s,children:y}),s?void 0:b]}),s?b:void 0]})})}W.displayName="AlertModal";export{W as A};
