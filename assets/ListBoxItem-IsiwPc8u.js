import{j as r}from"./jsx-runtime-BkBIjjFT.js";import{a,u as e,b as i,p}from"./index-ByEiyUmp.js";import{e as $,T as h}from"./index-BwV_lsCf.js";import{$ as b}from"./Dialog-Bow7UHhh.js";import{u as g}from"./OverlayContext-CQkNAI0D.js";import{b as k}from"./ListBox-BvcAl4ro.js";import{T as f}from"./Typography-C-GpEjPp.js";const x=a($)`
...
`;function D(){return r.jsx(x,{"aria-hidden":"true"})}const I=a(b)`
  ${()=>{const{tokens:{select:n,scrollBar:{thumbColor:o,trackColor:t}}}=e();return i`
      ...
      overflow: hidden;
    `}}
`,y=6,v=2,w=48,T=w*y,C=v+T;function P(n){const{tokens:o}=e(),{select:t}=o,{portalElement:s}=g();return r.jsx(I,{maxHeight:C,offset:parseInt(t.gap,10),UNSTABLE_portalContainer:s,...n})}const c=a(k)`
  ${()=>{const{tokens:n}=e(),{select:o}=n;return i`
      display: grid;
