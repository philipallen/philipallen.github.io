import{j as e}from"./jsx-runtime-sfY7k0Xq.js";import{r as c}from"./index-CcKhGcwW.js";import{r as H}from"./index-uaANFLeC.js";import{c as T,k as A,m as D,F as _,a as O,d as P,o as z,s as R}from"./floating-ui.react-CtreYAAZ.js";import{$ as U}from"./Collection-C9XxNqm0.js";import{M as l}from"./index-CssHJ6ns.js";import{a as s,u as a,b as d}from"./index-COZsQx0K.js";import{e as G,f as W}from"./Dialog-D7L8ikGJ.js";import{u as X}from"./OverlayContext-DE6V0lcf.js";import{S as N}from"./ScrollShadowContainer-C2NUBgcp.js";const V=s.div`
...
`,J=s.div`
  ${()=>{const{tokens:t}=a(),{menu:o}=t;return[d`
      ...
      `]}}
`;function so(t){const{items:o,offset:p=l.DEFAULT_OFFSET,padding:x,placement:k=l.DEFAULT_PLACEMENT,renderListItemContent:v,children:I,testID:g="menu",...y}=t,[r,u]=c.useState(!1),[$,C]=c.useState(),j=c.useId(),m=c.useId(),{refs:f,floatingStyles:w,context:h}=T({placement:k,open:r,onOpenChange:u,whileElementsMounted:P,middleware:[z(p),R({padding:16,apply({availableHeight:n}){H.flushSync(()=>C(n))}})]}),{portalElement:E}=X(),F=A(h),{getReferenceProps:M,getFloatingProps:L}=D([F]);function S(n){n.onClick(),u(!1)}let b=l.MAX_LIST_HEIGHT;return $&&$<l.MAX_LIST_HEIGHT&&(b=$),e.jsxs(e.Fragment,{children:[I({ref:f.setReference,id:j,onClick:()=>{u(!r)},"aria-controls":r?m:void 0,"aria-haspopup":"true","aria-expanded":r?"true":void 0,...M()}),r&&e.jsx(_,{root:E,children:e.jsx(O,{context:h,children:e.jsx(V,{ref:f.setFloating,id:m,$padding:x,style:w,"data-testid":g,...L(),children:e.jsx(q,{children:e.jsx("div",{style:{maxHeight:b},children:e.jsx(N,{children:e.jsx(B,{...y,children:e.jsx(U,{items:o,children:n=>e.jsx(i,{onAction:()=>{S(n)},"data-testid":`${g}-item-${n.id}`,children:e.jsx(J,{children:v(n)})})})})})})})})})})]})}export{so as M};
