...
`,ce=g(re)`
  ${({$isSelected:t})=>{const{tokens:n}=m(),{select:o}=n;return[a`
      ...
      `]}}
`;function de(t){return t?t.title:""}function f(t){const{labelProps:n,placeholder:o="Select",selectedItem:e,onChange:u,alertProps:y,testID:v="select",...I}=t,{isDisabled:R,items:M}=I,{tokens:N}=m(),{select:b}=N,{getLabelProps:X,getToggleButtonProps:J,getMenuProps:z,isOpen:G,getItemProps:K,highlightedIndex:U}=Z({items:M,selectedItem:e,itemToString:de,onSelectedItemChange:({selectedItem:h})=>u(h)}),P=Q.useId(),{labelHint:V}=n;return r.jsx(oe,{alert:y?r.jsx(ae,{...y,testID:`${v}-alert`}):void 0,children:r.jsx(le,{...n,...X(),labelHintID:P,children:r.jsx(ee,{...I,toggleButtonProps:{"aria-describedby":V?P:void 0},getToggleButtonProps:J,getMenuProps:z,isOpen:G,renderButtonContent:()=>r.jsx(ie,{$isDisabled:R,$hasSelectedItem:!!e,children:r.jsx(T,{component:"div",color:"inherit",variant:b.button.text.typography.variant,fontFamily:b.button.text.typography.fontFamily,noWrap:!0,children:e?e.title:o})}),renderListItem:(h,l,k)=>{const S=e===l,$=U===k;return r.jsx(se,{...K({key:l.id,ref:h,item:l,index:k}),"data-hovered":$||void 0,children:r.jsxs(pe,{$isSelected:S,$isHighlighted:$,children:[r.jsx(ce,{$isSelected:S,"aria-hidden":"true"}),r.jsx(T,{component:"div",color:"inherit",title:l.title,variant:b.menu.option.inner.text.typography.variant,fontFamily:b.menu.option.inner.text.typography.fontFamily,noWrap:!0,children:l.title})]})})},maxListHeight:ne,testID:v})})})}f.__docgenInfo={description:"",methods:[],displayName:"Select",props:{labelProps:{required:!0,tsType:{name:"Omit",elements:[{name:"intersection",raw:`Omit<
