import{j as o}from"./jsx-runtime-DQ32znRX.js";import{r as n}from"./index-DH5ua8nC.js";import{b as g}from"./useLabel-hJ0mwhYX.js";import{a as v}from"./Text-X8DQBs4N.js";function P(i){const{labelProps:e,alerts:l,children:s}=i,p=!!(e!=null&&e.label),u=!!(e!=null&&e.labelHint),m=!!l,a=n.useId(),t=n.useId(),r=n.useId(),c=p?a:void 0,y=[u&&t,m&&r].filter(Boolean).join(" ")||void 0,d={id:a},h={slots:{description:{id:t},errorMessage:{id:r}}};return o.jsx(g.Provider,{value:d,children:o.jsx(v.Provider,{value:h,children:s({labelledBy:c,describedBy:y})})})}P.__docgenInfo={description:"",methods:[],displayName:"ReactAriaProviders",props:{labelProps:{required:!1,tsType:{name:"Omit",elements:[{name:"PropsWithChildren",elements:[{name:"signature",type:"object",raw:`{
  label?: string;
...
>`,required:!0}},{key:"contentProps",value:{name:"signature",type:"object",raw:`{
  ...
  labelHint?: string;
  labelHintTooltipProps?: TooltipProps;
}>`},{name:"literal",value:'"children"'}],raw:'Omit<InputLabelTopV2Props, "children">'},description:""},alerts:{required:!1,tsType:{name:"Array",raw:'InputAlertsProps["alerts"]'},description:""},children:{required:!0,tsType:{name:"signature",type:"function",raw:"(props: RenderProps) => JSX.Element",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  labelledBy: string | undefined;
  describedBy: string | undefined;
}`,signature:{properties:[{key:"labelledBy",value:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}],required:!0}},{key:"describedBy",value:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}],required:!0}}]}},name:"props"}],return:{name:"JSX.Element"}}},description:""}}};export{P as R};
