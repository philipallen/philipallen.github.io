import{j as n}from"./jsx-runtime-sfY7k0Xq.js";import{a as i,u as s,b as a}from"./index-Dwsyfx_g.js";import{e as h}from"./index-BKbNTvCu.js";import{c as p,b as $}from"./Dialog-CYmhaE2o.js";import{u as m}from"./OverlayContext-DE6V0lcf.js";const f=i(h)`
...
`;function H(){return n.jsx(f,{"aria-hidden":"true"})}const x=i(p)`
  ${({$width:e})=>{const{tokens:{select:o,scrollBar:{thumbColor:t,trackColor:r}}}=s();return[a`
      ...
      `,e&&a`
          width: ${e}px;
        `]}}
`,I=6,g=2,T=48,v=T*I,w=g+v;function B(e){const{width:o,isOpen:t,onOpenChange:r,triggerRef:d,...l}=e,{tokens:u}=s(),{select:b}=u,{portalElement:c}=m();return n.jsx($,{getContainer:c&&(()=>c),children:n.jsx(x,{$width:o,maxHeight:w,offset:parseInt(b.gap,10),isOpen:t,onOpenChange:r,triggerRef:d,...l})})}export{H as C,w as M,B as P};
