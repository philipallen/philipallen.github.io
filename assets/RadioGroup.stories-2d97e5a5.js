import{f as e}from"./index-6eef940f.js";import{j as t}from"./jsx-runtime-6eef64cc.js";import{F as d}from"./Fieldset-29508e3b.js";import{R as g}from"./Radio-ec69f855.js";function l(s){const{legend:i,legendHint:m,inputs:p,testID:u="radio-group"}=s;return t.jsx(d,{legend:i,legendHint:m,components:p.map(c=>({component:t.jsx(g,{...c})})),testID:u})}l.__docgenInfo={description:"",methods:[],displayName:"RadioGroup",props:{inputs:{required:!0,tsType:{name:"Array",elements:[{name:"intersection",raw:`Omit<RadioProps, "name"> & {
