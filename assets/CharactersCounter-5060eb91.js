import{j as i}from"./jsx-runtime-6eef64cc.js";import{a,u as n,b as s}from"./index-40766bf6.js";import{r as f}from"./index-c013ead5.js";import{T as $}from"./Typography-ff2e0ce1.js";const e=a.div`
...
`;function m(r){const{hasError:t,children:o}=r;return i.jsx(e,{children:i.jsx(p,{$hasError:t,children:o})})}m.__docgenInfo={description:"",methods:[],displayName:"OuterField"};const g=a($)`
  ${()=>{const{tokens:r}=n(),{charactersCounter:t}=r;return s`
    ...
    `}}
`;function c(r){const{length:t,maxLength:o,testID:l}=r,{tokens:d}=n(),{charactersCounter:h}=d,u=Math.max(0,o-t);return i.jsx(g,{variant:h.typographyVariant,testID:l,"aria-live":"polite",children:`${u} character${u!==1?"s":""} remaining`})}const w=f.memo(c);c.__docgenInfo={description:"",methods:[],displayName:"CharactersCounter",props:{length:{required:!0,tsType:{name:"number"},description:""},maxLength:{required:!0,tsType:{name:"number"},description:""}}};export{w as C,m as O};
