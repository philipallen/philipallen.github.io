import{r as h}from"./index-DH5ua8nC.js";import{T as V,B as uo,I as ho}from"./index-D0yVWoN6.js";import{a,u as s,b as n,p as g,h as po}from"./index-CZQU1x5t.js";import{A as bo,a as go,C as U,E as $o,M as fo,T as q,b as ko,I as vo,c as mo}from"./index-B7-70OtY.js";import{j as d}from"./jsx-runtime-DQ32znRX.js";import{u as W,F as yo,a as wo}from"./floating-ui.react-BezaurJz.js";import{$ as xo,a as Co}from"./Button-D-U0fkv9.js";import{$ as Ro}from"./utils-DMjC9_eM.js";import{i as Io}from"./react-textarea-autosize.browser.esm-Dr6hbtpk.js";a.div`
...
`;a.div`
  ${({hidden:t})=>{const{tokens:o}=s(),{accordion:e}=o;return[n`
      ...
      `]}}
`;var Lo=a.p`
  ${({$variant:t,$fontFamily:o,$noWrap:e,$color:r})=>{const{tokens:i}=s(),{typography:l,fontFamily:c}=i,u=g(l.fontSize[t]),p=g(l.lineHeight[t]);return[n`
        margin: 0;
        font-weight: normal;
        color: ${r||l.color[t]};
        font-size: ${u};
      ...
      `,o&&n`
        ...
        `]}}
`;function jo(t,o){const{variant:e,component:r,color:i,fontFamily:l,noWrap:c,testID:u,...p}=t;return d.jsx(Lo,{...p,ref:o,as:r,$variant:e,$color:i,$fontFamily:l,$noWrap:c,"data-testid":u})}var To=h.forwardRef(jo),Bo={displayXL:"h1",displayL:"h1",displayM:"h1",displayS:"h1",headlineL:"h1",headlineM:"h2",headlineS:"h3",headlineXS:"h4",titleL:"h2",titleM:"h3",titleS:"h4",titleXS:"h5",bodyL:"p",bodyM:"p",bodyS:"p",labelM:"p",labelS:"p"},zo=h.forwardRef;function Fo(t,o){const{variant:e="bodyM",component:r,...i}=t;return d.jsx(To,{...i,ref:o,variant:e,component:r||Bo[e]})}var $=zo(Fo),Do=a.div`
...
`,Ao=a.div`
  ${({$variant:t,$isLoading:o})=>{const{tokens:e}=s(),{button:r}=e,{shadow:i}=r.bottomLayer;return[n`
      ...
      `,o&&n`
        ...
        `]}}
`,J=h.forwardRef((t,o)=>{const{variant:e,children:r,testID:i,type:l,isLoading:c,fullWidth:u,...p}=t;return d.jsxs(k,{...p,ref:o,$variant:e,$isLoading:c,$fullWidth:u,"data-testid":i,type:l||"button",children:[d.jsx(Ao,{$variant:e,$isLoading:c}),d.jsx(Oo,{$variant:e,$isLoading:c,children:r})]})});J.displayName="ButtonBase";var Eo=J,No=po`
  0% {
...
`,P=a.div`
  ...
  ${({$index:t,$borderWidth:o})=>n`
    ...
    `}
`,K=h.memo(t=>{const{testID:o="spinner"}=t,{tokens:{spinner:e}}=s();let r,i;if("variant"in t){const u=e.variants[t.variant];u&&([r,i]=[u.color,u.size])}"size"in t&&t.size?i=t.size:i||(i=e.variants.default.size),"color"in t&&t.color?r=t.color:r||(r=e.variants.default.color);const c={$borderWidth:`${Math.round(parseInt(i)/parseInt(e.borderRatio))}px`};return d.jsxs(Ho,{$color:r,$size:i,"data-testid":o,children:[d.jsx(Yo,{...c}),d.jsx(P,{$index:0,...c}),d.jsx(P,{$index:1,...c}),d.jsx(P,{$index:2,...c})]})});K.displayName="Spinner";var Mo=K,Vo=h.forwardRef((t,o)=>{const{text:e,variant:r="primary",startIcon:i,isLoading:l,testID:c="button",...u}=t,{tokens:p}=s(),{button:f}=p,b={"aria-disabled":l,"aria-label":l?"Loading":void 0};return d.jsx(Eo,{...u,...b,ref:o,variant:r,isLoading:l,testID:c,children:d.jsxs(So,{children:[i&&d.jsx(Po,{$isLoading:l,children:i}),d.jsx(_o,{$isLoading:l,children:d.jsx($,{variant:f.topLayer.text.typography.variant,fontFamily:f.topLayer.text.typography.fontFamily,noWrap:!0,color:"inherit",testID:`${c}-text`,children:e})}),l&&d.jsx(Wo,{children:d.jsx(Mo,{variant:uo.SPINNER_VARIANTS[r],testID:`${c}-spinner`})})]})})});Vo.displayName="Button";var Go=a.div`
  ${({$gap:t="8px"})=>`
    display: grid;
    justify-items: start;
    gap: ${t};
...
`,Qo=a.span`
  ${()=>{const{tokens:t}=s(),{inputLabelRight:o}=t;return n`
    ...
    `}}
`;function Zo(t){const{label:o,children:e,...r}=t,{tokens:i}=s(),{inputLabelRight:l}=i;return d.jsxs(Ko,{...r,children:[d.jsx("span",{children:e}),o&&d.jsx(Qo,{children:d.jsx($,{component:"span",color:"inherit",variant:l.label.typography.variant,fontFamily:l.label.typography.fontFamily,children:o})})]})}var Q=Zo,E=a.div`
...
`,et=a(q)`
  ${()=>{const{tokens:t}=s(),{checkbox:o}=t;return[n`
      ...
      `]}}
`;function rt(t,o){h.useEffect(()=>{t.current&&(t.current.indeterminate=!!o)},[o])}var Z=h.forwardRef((t,o)=>{const{hasError:e,isIndeterminate:r,testID:i="checkbox",...l}=t,c=h.useRef(null);rt(c,r);const u=W([c,o]);function p(f){var b;f.target.indeterminate=!!r,(b=l.onChange)==null||b.call(l,f)}return d.jsxs(E,{$hasError:e,children:[d.jsx(ot,{...l,ref:u,type:"checkbox",onChange:p,"data-testid":i}),d.jsx(tt,{}),d.jsx(et,{})]})});Z.displayName="CheckboxBase";var nt=Z,it=h.forwardRef((t,o)=>{const{labelProps:e,alertProps:r,...i}=t,{testID:l="checkbox"}=i;return d.jsx(O,{alert:r?d.jsx(A,{...r,testID:`${l}-alert`}):void 0,children:d.jsx(Q,{...e,children:d.jsx(nt,{...i,ref:o})})})});it.displayName="Checkbox";a.fieldset`
...
`;a.li`
  ${()=>{const{tokens:t}=s(),{fieldset:o}=t;return n`
    ...
    `}}
`;var st=a.div`
  ${({$labelText:t})=>{const{tokens:o}=s(),{inputLabelTop:e}=o;return[n`
        width: 100%;
        display: grid;
      `,t&&n`
          gap: ${e.gap};
...
`,lt=a.div`
  ${()=>{const{tokens:t}=s(),{inputLabelTop:o}=t;return n`
    ...
    `}}
`;function oo(t){const{labelElement:o,labelText:e,labelHint:r,labelHintID:i,children:l}=t,{tokens:c}=s(),{inputLabelTop:u}=c;return d.jsxs(st,{$labelText:e,children:[d.jsxs("div",{children:[o,r&&d.jsx(lt,{children:d.jsx($,{id:i,component:"span",color:"inherit",variant:u.labelHint.typography.variant,fontFamily:u.labelHint.typography.fontFamily,children:r})})]}),d.jsx("div",{children:l})]})}oo.Label=t=>{const{text:o,component:e="span"}=t,{tokens:r}=s(),{inputLabelTop:i}=r;return d.jsx(dt,{children:d.jsx($,{component:e,color:"inherit",variant:i.label.typography.variant,fontFamily:i.label.typography.fontFamily,children:o})})};var G=oo;function ct(t){const{label:o,labelHint:e,labelHintID:r,children:i,...l}=t;return d.jsx(G,{labelElement:d.jsx("label",{...l,children:o&&d.jsx(G.Label,{text:o})}),labelText:o,labelHint:e,labelHintID:r,children:i})}var to=ct,eo=a(to)`
  ${()=>n`
      width: 100%;
    `}
`,ut=a.div`
...
`;function $t(t){const{hasError:o,children:e}=t;return d.jsx(v,{children:d.jsx(gt,{$hasError:o,children:e})})}var ft=$t,kt=a($)`
  ${()=>{const{tokens:t}=s(),{charactersCounter:o}=t;return n`
    ...
    `}}
`;function vt(t){const{length:o,maxLength:e,testID:r}=t,{tokens:i}=s(),{charactersCounter:l}=i,c=Math.max(0,e-o);return d.jsx(kt,{variant:l.typography.variant,fontFamily:l.typography.fontFamily,testID:r,"aria-live":"polite",children:`${c} character${c!==1?"s":""} remaining`})}var mt=h.memo(vt),yt=h.forwardRef((t,o)=>{var B;const{id:e,hasError:r,prefix:i,icon:l,onChange:c,testID:u="input",labelProps:p,alertProps:f,...b}=t,w=h.useId(),x=h.useId(),{labelHint:S}=p,{maxLength:L}=b,{tokens:{textInput:j}}=s(),[C,Y]=h.useState(((B=b.value||b.defaultValue)==null?void 0:B.length)||0),T=h.useCallback(z=>{Y(z.target.value.length),c==null||c(z)},[c]);return d.jsxs(O,{gap:b.maxLength?"4px":"8px",alert:f?d.jsx(A,{...f,testID:`${u}-alert`}):void 0,children:[d.jsx(eo,{...p,labelHintID:x,htmlFor:e||w,children:d.jsx(ft,{hasError:r,children:d.jsxs(ut,{children:[i?d.jsx(pt,{variant:j.prefix.typography.variant,fontFamily:j.prefix.typography.fontFamily,testID:`${u}-prefix`,children:i}):void 0,d.jsx(ht,{...b,ref:o,id:e||w,onChange:T,"aria-describedby":S?x:void 0,"data-testid":u}),l?d.jsx(bt,{"data-testid":`${u}-icon-wrapper`,children:l}):void 0]})})}),L?d.jsx(mt,{length:C,maxLength:L,testID:`${u}-characters-counter`}):void 0]})});yt.displayName="TextInput";a.div`
...
`,wt=a.div`
  ${({$variant:t})=>{const{tokens:o}=s(),{iconButton:e}=o;return[n`
      ...
      `,t==="contained"&&n`
        ...
        `]}}
`,ro=h.forwardRef((t,o)=>{const{variant:e=ho.DEFAULT_VARIANT,children:r,testID:i="icon-button",...l}=t;return d.jsx(R,{...l,ref:o,$variant:e,"data-testid":i,children:d.jsx(wt,{$variant:e,children:r})})});ro.displayName="IconButton";var xt=ro,Ct=h.forwardRef((t,o)=>{[t,o]=Ro(t,o,Co);const{buttonProps:e}=xo(t,o);return d.jsxs(xt,{...e,ref:o,children:[t.slot==="previous"&&d.jsx(bo,{}),t.slot==="next"&&d.jsx(go,{})]})});Ct.displayName="DatePickerIconButton";var Rt=a.div`
  position: relative;
  display: flex;
  align-items: center;
  width: 100%;
`,It=a.input`
  ${({$error:t,$hasStartAdornment:o,$hasEndAdornment:e,$hasClearButton:r})=>{const{tokens:i}=s(),{input:l,adornment:c,clearButton:u}=i;return[n`
        height: ${l.height};
        width: 100%;
...
`,Lt=a.div`
  ${()=>{const{tokens:t}=s(),{clearButton:o}=t;return n`
    ...
    `}}
`,no=t=>({id:t.id,className:t.className,"data-testid":t.testID}),jt=({onClick:t,...o})=>{const{tokens:e}=s(),{clearButton:r}=e;return d.jsx(Lt,{...no(o),role:"button",onClick:t,children:d.jsx(U,{width:16,height:16,color:r.color.base})})},Tt=a.div`
  display: flex;
...
`,zt=a.div`
  ${()=>{const{tokens:t}=s(),{fontFamily:o,themeColor:e}=t;return[n`
        ...
        width: 100%;
      `]}}
`,Ft=({elementId:t,labelId:o,labelText:e,errorText:r,children:i,labelTestId:l,...c})=>d.jsxs(Tt,{...no(c),children:[e?d.jsx($,{id:o,component:"label",htmlFor:t,testID:l,children:e}):null,d.jsxs(Bt,{children:[i,r?d.jsx(zt,{children:r}):null]})]}),Dt=h.forwardRef(({hasClearButton:t=!0,startAdornment:o,endAdornment:e,isError:r,errorText:i,onChange:l,labelId:c,labelText:u,labelTestId:p,testID:f,...b},w)=>{const{disabled:x,readOnly:S,value:L="",id:j}=b,C=h.useRef(null),T=t&&!(x||S)&&!!L;h.useImperativeHandle(w,()=>C.current);const B=()=>{typeof l=="function"&&l(""),C.current&&C.current.focus()},z=M=>{typeof l=="function"&&l(M.target.value,M)};return d.jsx(Ft,{labelId:c,labelText:u,labelTestId:p,errorText:i,elementId:j,children:d.jsxs(Rt,{children:[o,d.jsx(It,{...b,$hasClearButton:T,$hasStartAdornment:!!o,$hasEndAdornment:!!e,ref:C,$error:r||!!i,onChange:z,"data-testid":f}),T&&!e?d.jsx(jt,{testID:"input-clear-button",onClick:B}):null,e]})})});Dt.displayName="Input";var St=a.a`
  ${({$display:t})=>{const{tokens:o}=s(),{link:e}=o;return n`
    ...
    `}}
`,Pt=h.forwardRef;function _t(t,o){const{display:e="inline",component:r="a",testID:i="link",...l}=t;return d.jsx(St,{...l,ref:o,as:r,"data-testid":i,$display:e})}var io=Pt(_t),ao=a(io)``,Wt=a($)`
  ${()=>{const{tokens:t}=s(),{link:o}=t;return n`
    ...
    `}}
`,Ot=h.forwardRef((t,o)=>{const{children:e,...r}=t,{tokens:i}=s(),{link:l}=i;return d.jsx(ao,{...r,ref:o,children:d.jsx(Wt,{component:"span",color:"inherit",variant:l.typography.variant,fontFamily:l.typography.fontFamily,children:e})})});Ot.displayName="Link";var so=a(io)``,_=a.div`
  ${()=>{const{tokens:t}=s(),{link:o}=t;return[n`
        display: inline-flex;
        gap: ${o.withIcon.gap};
      `]}}
...
`,X=a.div`
  ${()=>{const{tokens:t}=s(),{link:o}=t,e=g(o.withIcon.size);return n`
    ...
    `}}
`,Et=h.forwardRef((t,o)=>{const{children:e,startIcon:r,endIcon:i,testID:l="link",...c}=t,{tokens:u}=s(),{link:p}=u;return d.jsx(so,{...c,ref:o,display:"inline-flex",testID:l,children:d.jsxs(_,{children:[r&&d.jsx(X,{"data-testid":`${l}-start-icon-wrapper`,children:r}),d.jsx(At,{component:"span",color:"inherit",variant:p.typography.variant,fontFamily:p.typography.fontFamily,children:e}),i&&d.jsx(X,{"data-testid":`${l}-end-icon-wrapper`,children:i})]})})});Et.displayName="LinkWithIcon";a.div`
  overflow: hidden;
`;a.div`
...
`,Yt=a.div`
  ${()=>{const{tokens:t}=s(),{radio:o}=t;return[n`
      ...
      `]}}
`,co=h.forwardRef((t,o)=>{const{hasError:e,testID:r="radio",...i}=t;return d.jsxs(F,{$hasError:e,children:[d.jsx(Ht,{...i,ref:o,type:"radio","data-testid":r}),d.jsx(Yt,{})]})});co.displayName="RadioBase";var Mt=co,Vt=h.forwardRef((t,o)=>{const{labelProps:e,alertProps:r,...i}=t,{testID:l="radio"}=i;return d.jsx(O,{alert:r?d.jsx(A,{...r,testID:`${l}-alert`}):void 0,children:d.jsx(Q,{...e,children:d.jsx(Mt,{...i,ref:o})})})});Vt.displayName="Radio";a.div`
...
`;a.div`
  ...
  ${({$displayInnerShadow:t})=>{const{tokens:o}=s(),{textArea:e,outerField:r}=o;return n`
    ...
    `}}
`;a(Io)`
  ${()=>{const{tokens:t}=s(),{textArea:o,typography:e,scrollBar:r,outerField:i}=t,l=o.typography.variant,c=g(e.fontSize[l]),u=g(e.lineHeight[l]);return n`
      all: unset;
...
`;a.div`
  ${({$toggleSize:t})=>{const{tokens:{toggle:o}}=s(),e=g(o.size[t].width);return n`
    ...
    `}}
`;var Ut=h.createContext(null),H=()=>{const t=h.useContext(Ut);if(!t)throw new Error("Tooltip components must be wrapped in <Tooltip />");return t},qt=a.div`
...
`,Jt=a.button`
  ${()=>{const{tokens:t}=s(),{tooltip:o}=t;return n`
    ...
    `}}
`,Kt=h.forwardRef((t,o)=>{const{children:e,...r}=t,{tokens:i}=s(),{tooltip:l}=i,{open:c,setOpen:u,isControlled:p,arrowRef:f,floatingData:b,interactionsData:w}=H(),x=W([b.refs.setFloating,o]);return c?d.jsx(yo,{children:d.jsxs(qt,{ref:x,style:b.floatingStyles,...w.getFloatingProps(r),$isControlled:p,children:[d.jsx(wo,{ref:f,context:b.context,fill:l.backgroundColor,width:parseInt(l.arrow.width),height:parseInt(l.arrow.height)}),p&&d.jsx(Jt,{onClick:()=>u(!1),"aria-label":"Close tooltip",children:d.jsx(U,{})}),e]})}):null});Kt.displayName="TooltipContent";var y=a.button`
...
`,oe=a(mo)`
  ${({$isControlled:t,$isOpen:o})=>{const{tokens:e}=s(),{iconButton:r,tooltipIconButton:i}=e;return[n`
      ...
      `,!t&&n`
        ...
        `]}}
`,te=h.forwardRef((t,o)=>{const{testID:e="tooltip-icon-button",...r}=t,{open:i,isControlled:l}=H();return d.jsx(y,{...r,ref:o,$isControlled:l,"data-testid":e,children:d.jsxs(Qt,{children:[d.jsx(Zt,{$isOpen:i,$isControlled:l}),d.jsx(oe,{$isOpen:i,$isControlled:l})]})})});te.displayName="TooltipIconButton";var ee=h.forwardRef((t,o)=>{const{children:e,...r}=t,{open:i,floatingData:l,interactionsData:c}=H(),u=e.ref,p=W([l.refs.setReference,u,o]);return h.isValidElement(e)?h.cloneElement(e,c.getReferenceProps({ref:p,...r,...e.props,"data-state":i?"open":"closed"})):null});ee.displayName="TooltipTrigger";export{he as T,$ as a};
