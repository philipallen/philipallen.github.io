import{j as t}from"./jsx-runtime-sfY7k0Xq.js";import{r as v}from"./index-CcKhGcwW.js";import{A as p}from"./index-ChacPRz0.js";import{a,u as n,b as d}from"./index-Dwsyfx_g.js";import{e as y}from"./index-BKbNTvCu.js";import{$ as E}from"./Button-DHrRVfeM.js";import{$ as j,a as w}from"./Disclosure-DP_NoHsP.js";import{T as A}from"./Typography-Ck2BLUk-.js";const C=a(j)`
...
`,O=a(w)`
  ${({$isExpanded:o})=>{const{tokens:r}=n(),{accordion:e}=r;return[o&&d`
        ...
        `]}}
`;function T(o){const{title:r,content:e,isOpen:$,initialOpen:g=!1,onChange:f,variant:s=p.DEFAULT_VARIANT,headingLevel:u=p.DEFAULT_HEADING_LEVEL,testID:l="accordion"}=o,{tokens:b}=n(),{accordion:h}=b,[x,m]=v.useState(g),c=$??x,k=f??m;return t.jsxs(C,{isExpanded:c,onExpandedChange:k,$variant:s,"data-testid":l,children:[t.jsxs(i,{slot:"trigger",$variant:s,"data-testid":`${l}-header`,children:[t.jsxs(R,{$variant:s,children:[t.jsx(A,{color:"inherit",component:`h${u}`,variant:h.header.text.typography.variant[s],fontFamily:h.header.text.typography.fontFamily,children:r}),t.jsx(D,{$isExpanded:c,children:t.jsx(y,{})})]}),t.jsx(I,{$isExpanded:c})]}),t.jsx(O,{$isExpanded:c,"data-testid":`${l}-content`,children:e})]})}T.displayName="Accordion";export{T as A};
