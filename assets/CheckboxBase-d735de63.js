import{j as i}from"./jsx-runtime-6eef64cc.js";import{r as c}from"./index-c013ead5.js";import{u as w}from"./floating-ui.react-06582175.js";import{a as d,u as s,b as n}from"./index-4d2d77c0.js";import{M as m,T as v}from"./index-71d43b47.js";const h=d.div`
...
`,C=d(v)`
  ${()=>{const{tokens:t}=s(),{checkbox:o}=t;return[n`
      ...
      `]}}
`;function y(t,o){c.useEffect(()=>{t.current&&(t.current.indeterminate=!!o)},[o])}const b=c.forwardRef((t,o)=>{const{hasError:e,isIndeterminate:a,testID:p="checkbox",...r}=t,l=c.useRef(null);y(l,a);const $=w([l,o]);function g(u){var k;u.target.indeterminate=!!a,(k=r.onChange)==null||k.call(r,u)}return i.jsxs(h,{$hasError:e,children:[i.jsx(f,{...r,ref:$,type:"checkbox",onChange:g,"data-testid":p}),i.jsx(x,{}),i.jsx(C,{})]})});b.displayName="CheckboxBase";b.__docgenInfo={description:"",methods:[],displayName:"CheckboxBase"};export{b as C};
