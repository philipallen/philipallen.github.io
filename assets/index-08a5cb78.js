import{r as p}from"./index-c013ead5.js";import{T as B,B as oo}from"./index-7aa2f780.js";import{a,u as s,p as g,b as n,h as to}from"./index-4d2d77c0.js";import{j as l}from"./jsx-runtime-6eef64cc.js";import{C as eo,E as ro,M as no,T as F,a as io}from"./index-71d43b47.js";import{u as R,F as ao,a as so}from"./floating-ui.react-06582175.js";import{i as lo}from"./react-textarea-autosize.browser.esm-05f9ff93.js";var co=a.div`
  display: flex;
  flex-direction: row;
  align-items: center;
...
`,zo=a.div`
  ${()=>{const{tokens:t}=s(),{inputAlert:o}=t,e=g(o.iconWrapper.height);return n`
      ...
      height: ${e};
    `}}
`;function So(t){const{severity:o,children:e,testID:r="input-alert"}=t,{tokens:i}=s(),{inputAlert:d}=i;return l.jsxs(Bo,{role:"alert","aria-live":"polite",$severity:o,"data-testid":r,children:[l.jsx(zo,{children:l.jsx(ro,{primaryColor:d.icon.primaryColor[o],secondaryColor:d.icon.secondaryColor[o],"aria-hidden":"true"})}),l.jsx($,{color:"inherit",children:e})]})}var W=So,Fo=a.label`
